...
public:
	...
	float                                         SkipContinuingPoseMaxCost;                         // 0x0024(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         PlayRateMin;                                       // 0x0028(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         PlayRateMax;                                       // 0x002C(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
...
static_assert(offsetof(FMotionMatchingSettings, SkipContinuingPoseMaxCost) == 0x000024, "Member 'FMotionMatchingSettings::SkipContinuingPoseMaxCost' has a wrong offset!");
static_assert(offsetof(FMotionMatchingSettings, PlayRateMin) == 0x000028, "Member 'FMotionMatchingSettings::PlayRateMin' has a wrong offset!");
static_assert(offsetof(FMotionMatchingSettings, PlayRateMax) == 0x00002C, "Member 'FMotionMatchingSettings::PlayRateMax' has a wrong offset!");

// ScriptStruct PoseSearch.PoseSearchProceduralMovement
// 0x0070 (0x0070 - 0x0000)
struct alignas(0x10) FPoseSearchProceduralMovement final
{
public:
	uint8                                         Pad_0[0x70];                                       // 0x0000(0x0070)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(FPoseSearchProceduralMovement) == 0x000010, "Wrong alignment on FPoseSearchProceduralMovement");
static_assert(sizeof(FPoseSearchProceduralMovement) == 0x000070, "Wrong size on FPoseSearchProceduralMovement");
...
public:
	...
	struct FMotionMatchingSettings                Settings;                                          // 0x0088(0x0030)(Edit, BlueprintVisible, NoDestructor, NativeAccessSpecifierPublic)
	uint8                                         Pad_B8[0x8];                                       // 0x00B8(0x0008)(Fixing Size After Last Property [ Dumper-7 ])
	struct FPoseSearchProceduralMovement          ProceduralMovement;                                // 0x00C0(0x0070)(Edit, BlueprintVisible, NativeAccessSpecifierPublic)
	bool                                          bResetOnBecomingRelevant;                          // 0x0130(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bForceInterrupt;                                   // 0x0131(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_132[0x1AE];                                    // 0x0132(0x01AE)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(FAnimNode_MotionMatching) == 0x000010, "Wrong alignment on FAnimNode_MotionMatching");
static_assert(sizeof(FAnimNode_MotionMatching) == 0x0002E0, "Wrong size on FAnimNode_MotionMatching");
...
static_assert(offsetof(FAnimNode_MotionMatching, ProceduralMovement) == 0x0000C0, "Member 'FAnimNode_MotionMatching::ProceduralMovement' has a wrong offset!");
static_assert(offsetof(FAnimNode_MotionMatching, bResetOnBecomingRelevant) == 0x000130, "Member 'FAnimNode_MotionMatching::bResetOnBecomingRelevant' has a wrong offset!");
static_assert(offsetof(FAnimNode_MotionMatching, bForceInterrupt) == 0x000131, "Member 'FAnimNode_MotionMatching::bForceInterrupt' has a wrong offset!");
...
public:
	...
	float                                         PCAExplainedVariance;                              // 0x00A0(0x0004)(Edit, ZeroConstructor, EditConst, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_A4[0x4];                                       // 0x00A4(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	TArray<float>                                 Deviation;                                         // 0x00A8(0x0010)(Edit, ZeroConstructor, EditConst, NativeAccessSpecifierPublic)
};
static_assert(alignof(FPoseSearchIndex) == 0x000008, "Wrong alignment on FPoseSearchIndex");
static_assert(sizeof(FPoseSearchIndex) == 0x0000B8, "Wrong size on FPoseSearchIndex");
...
static_assert(offsetof(FPoseSearchIndex, PCAExplainedVariance) == 0x0000A0, "Member 'FPoseSearchIndex::PCAExplainedVariance' has a wrong offset!");
static_assert(offsetof(FPoseSearchIndex, Deviation) == 0x0000A8, "Member 'FPoseSearchIndex::Deviation' has a wrong offset!");
...
public:
	...
	float                                         ContinuingPoseCostAddend;                          // 0x0004(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
static_assert(alignof(FPoseSearchCost) == 0x000004, "Wrong alignment on FPoseSearchCost");
static_assert(sizeof(FPoseSearchCost) == 0x000008, "Wrong size on FPoseSearchCost");
static_assert(offsetof(FPoseSearchCost, TotalCost) == 0x000000, "Member 'FPoseSearchCost::TotalCost' has a wrong offset!");
static_assert(offsetof(FPoseSearchCost, ContinuingPoseCostAddend) == 0x000004, "Member 'FPoseSearchCost::ContinuingPoseCostAddend' has a wrong offset!");
...
// ScriptStruct PoseSearch.PoseSearchProceduralMovementSteeringSettings
// 0x0008 (0x0008 - 0x0000)
struct FPoseSearchProceduralMovementSteeringSettings final
{
public:
	float                                         MaxSteeringRotationRateDegreesPerSecond;           // 0x0000(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         MinSteeringAngleDegrees;                           // 0x0004(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
static_assert(alignof(FPoseSearchProceduralMovementSteeringSettings) == 0x000004, "Wrong alignment on FPoseSearchProceduralMovementSteeringSettings");
static_assert(sizeof(FPoseSearchProceduralMovementSteeringSettings) == 0x000008, "Wrong size on FPoseSearchProceduralMovementSteeringSettings");
static_assert(offsetof(FPoseSearchProceduralMovementSteeringSettings, MaxSteeringRotationRateDegreesPerSecond) == 0x000000, "Member 'FPoseSearchProceduralMovementSteeringSettings::MaxSteeringRotationRateDegreesPerSecond' has a wrong offset!");
static_assert(offsetof(FPoseSearchProceduralMovementSteeringSettings, MinSteeringAngleDegrees) == 0x000004, "Member 'FPoseSearchProceduralMovementSteeringSettings::MinSteeringAngleDegrees' has a wrong offset!");
...
// ScriptStruct PoseSearch.PoseSearchKeepRootRotationSample
// 0x0008 (0x0008 - 0x0000)
struct FPoseSearchKeepRootRotationSample final
{
public:
	float                                         SecondsOffset;                                     // 0x0000(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(alignof(FPoseSearchKeepRootRotationSample) == 0x000004, "Wrong alignment on FPoseSearchKeepRootRotationSample");
static_assert(sizeof(FPoseSearchKeepRootRotationSample) == 0x000008, "Wrong size on FPoseSearchKeepRootRotationSample");
static_assert(offsetof(FPoseSearchKeepRootRotationSample, SecondsOffset) == 0x000000, "Member 'FPoseSearchKeepRootRotationSample::SecondsOffset' has a wrong offset!");
static_assert(offsetof(FPoseSearchKeepRootRotationSample, Weight) == 0x000004, "Member 'FPoseSearchKeepRootRotationSample::Weight' has a wrong offset!");

// ScriptStruct PoseSearch.PoseSearchBoneRotationFilter
// 0x000C (0x000C - 0x0000)
struct FPoseSearchBoneRotationFilter final
{
public:
	float                                         SecondsOffset;                                     // 0x0000(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         ValidAngle;                                        // 0x0004(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         DesiredQueryOffset;                                // 0x0008(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
static_assert(alignof(FPoseSearchBoneRotationFilter) == 0x000004, "Wrong alignment on FPoseSearchBoneRotationFilter");
static_assert(sizeof(FPoseSearchBoneRotationFilter) == 0x00000C, "Wrong size on FPoseSearchBoneRotationFilter");
static_assert(offsetof(FPoseSearchBoneRotationFilter, SecondsOffset) == 0x000000, "Member 'FPoseSearchBoneRotationFilter::SecondsOffset' has a wrong offset!");
static_assert(offsetof(FPoseSearchBoneRotationFilter, ValidAngle) == 0x000004, "Member 'FPoseSearchBoneRotationFilter::ValidAngle' has a wrong offset!");
static_assert(offsetof(FPoseSearchBoneRotationFilter, DesiredQueryOffset) == 0x000008, "Member 'FPoseSearchBoneRotationFilter::DesiredQueryOffset' has a wrong offset!");

// ScriptStruct PoseSearch.PoseSearchBoneRotationSample
// 0x0018 (0x0018 - 0x0000)
struct FPoseSearchBoneRotationSample final
{
public:
	float                                         Offset;                                            // 0x0000(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         Weight;                                            // 0x0004(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	int32                                         FocusColorPresetIndex;                             // 0x0008(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         DesiredQueryOffset;                                // 0x000C(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         ScaleThresholdAngle;                               // 0x0010(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         ScaleThresholdFactor;                              // 0x0014(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
static_assert(alignof(FPoseSearchBoneRotationSample) == 0x000004, "Wrong alignment on FPoseSearchBoneRotationSample");
static_assert(sizeof(FPoseSearchBoneRotationSample) == 0x000018, "Wrong size on FPoseSearchBoneRotationSample");
static_assert(offsetof(FPoseSearchBoneRotationSample, Offset) == 0x000000, "Member 'FPoseSearchBoneRotationSample::Offset' has a wrong offset!");
static_assert(offsetof(FPoseSearchBoneRotationSample, Weight) == 0x000004, "Member 'FPoseSearchBoneRotationSample::Weight' has a wrong offset!");
static_assert(offsetof(FPoseSearchBoneRotationSample, FocusColorPresetIndex) == 0x000008, "Member 'FPoseSearchBoneRotationSample::FocusColorPresetIndex' has a wrong offset!");
static_assert(offsetof(FPoseSearchBoneRotationSample, DesiredQueryOffset) == 0x00000C, "Member 'FPoseSearchBoneRotationSample::DesiredQueryOffset' has a wrong offset!");
static_assert(offsetof(FPoseSearchBoneRotationSample, ScaleThresholdAngle) == 0x000010, "Member 'FPoseSearchBoneRotationSample::ScaleThresholdAngle' has a wrong offset!");
static_assert(offsetof(FPoseSearchBoneRotationSample, ScaleThresholdFactor) == 0x000014, "Member 'FPoseSearchBoneRotationSample::ScaleThresholdFactor' has a wrong offset!");
...
public:
	...
	float                                         ElapsedPoseJumpTime;                               // 0x0060(0x0004)(ZeroConstructor, Transient, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_64[0x4];                                       // 0x0064(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	struct FVector                                WantedBlendParameters;                             // 0x0068(0x0018)(ZeroConstructor, Transient, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         WantedPlayRate;                                    // 0x0080(0x0004)(ZeroConstructor, Transient, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	EMotionMatchingFlags                          Flags;                                             // 0x0084(0x0001)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, EditConst, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_85[0xB];                                       // 0x0085(0x000B)(Fixing Size After Last Property [ Dumper-7 ])
	struct FTransform                             RootMotionTransformDelta;                          // 0x0090(0x0060)(Transient, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(FMotionMatchingState) == 0x000140, "Wrong size on FMotionMatchingState");
static_assert(offsetof(FMotionMatchingState, ElapsedPoseJumpTime) == 0x000060, "Member 'FMotionMatchingState::ElapsedPoseJumpTime' has a wrong offset!");
static_assert(offsetof(FMotionMatchingState, WantedBlendParameters) == 0x000068, "Member 'FMotionMatchingState::WantedBlendParameters' has a wrong offset!");
static_assert(offsetof(FMotionMatchingState, WantedPlayRate) == 0x000080, "Member 'FMotionMatchingState::WantedPlayRate' has a wrong offset!");
static_assert(offsetof(FMotionMatchingState, Flags) == 0x000084, "Member 'FMotionMatchingState::Flags' has a wrong offset!");
static_assert(offsetof(FMotionMatchingState, RootMotionTransformDelta) == 0x000090, "Member 'FMotionMatchingState::RootMotionTransformDelta' has a wrong offset!");
