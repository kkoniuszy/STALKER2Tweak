...
public:
	...
	int32                                         Milliseconds;                                      // 0x0050(0x0004)(Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(SunPositionFunctionLibrary_GetSunPosition) == 0x000058, "Wrong size on SunPositionFunctionLibrary_GetSunPosition");
...
static_assert(offsetof(SunPositionFunctionLibrary_GetSunPosition, Milliseconds) == 0x000050, "Member 'SunPositionFunctionLibrary_GetSunPosition::Milliseconds' has a wrong offset!");
