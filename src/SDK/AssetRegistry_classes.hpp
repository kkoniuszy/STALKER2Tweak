...
public:
	...
	static class FString GetShortName(const struct FAssetData& InAssetData);
	...
	static void SortAssetData(const TArray<struct FAssetData>& InAssetData, TArray<struct FAssetData>* OutAssetData);
...
{
public:
	uint8                                         Pad_28[0xA40];                                     // 0x0028(0x0A40)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(UAssetRegistryImpl) == 0x000A68, "Wrong size on UAssetRegistryImpl");
