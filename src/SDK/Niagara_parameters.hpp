...
// Function Niagara.NiagaraActor.GetAssetPathNameOrSetChangedHandler
// 0x0010 (0x0010 - 0x0000)
struct NiagaraActor_GetAssetPathNameOrSetChangedHandler final
{
public:
	class FString                                 ReturnValue;                                       // 0x0000(0x0010)(Parm, OutParm, ZeroConstructor, ReturnParm, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
static_assert(alignof(NiagaraActor_GetAssetPathNameOrSetChangedHandler) == 0x000008, "Wrong alignment on NiagaraActor_GetAssetPathNameOrSetChangedHandler");
static_assert(sizeof(NiagaraActor_GetAssetPathNameOrSetChangedHandler) == 0x000010, "Wrong size on NiagaraActor_GetAssetPathNameOrSetChangedHandler");
static_assert(offsetof(NiagaraActor_GetAssetPathNameOrSetChangedHandler, ReturnValue) == 0x000000, "Member 'NiagaraActor_GetAssetPathNameOrSetChangedHandler::ReturnValue' has a wrong offset!");
