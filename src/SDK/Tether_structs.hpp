...
public:
	...
	bool                                          bAutoTile;                                         // 0x0039(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bSnapToNearestFullTile;                            // 0x003A(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_3B[0x1];                                       // 0x003B(0x0001)(Fixing Size After Last Property [ Dumper-7 ])
	float                                         TileUVs;                                           // 0x003C(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
...
static_assert(offsetof(FCustomMeshProperties, bAutoTile) == 0x000039, "Member 'FCustomMeshProperties::bAutoTile' has a wrong offset!");
static_assert(offsetof(FCustomMeshProperties, bSnapToNearestFullTile) == 0x00003A, "Member 'FCustomMeshProperties::bSnapToNearestFullTile' has a wrong offset!");
static_assert(offsetof(FCustomMeshProperties, TileUVs) == 0x00003C, "Member 'FCustomMeshProperties::TileUVs' has a wrong offset!");
...
static_assert(offsetof(FTetherSimulationParams, SegmentParams) == 0x000070, "Member 'FTetherSimulationParams::SegmentParams' has a wrong offset!");
