...
public:
	...
	bool                                          bVoxelize;                                         // 0x0015(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	EGroomGeometryType                            GeometryType;                                      // 0x0016(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	EGroomBindingType                             BindingType;                                       // 0x0017(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, AdvancedDisplay, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	EGroomOverrideType                            Simulation;                                        // 0x0018(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, AdvancedDisplay, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	EGroomOverrideType                            GlobalInterpolation;                               // 0x0019(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, AdvancedDisplay, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(offsetof(FHairLODSettings, bVoxelize) == 0x000015, "Member 'FHairLODSettings::bVoxelize' has a wrong offset!");
static_assert(offsetof(FHairLODSettings, GeometryType) == 0x000016, "Member 'FHairLODSettings::GeometryType' has a wrong offset!");
static_assert(offsetof(FHairLODSettings, BindingType) == 0x000017, "Member 'FHairLODSettings::BindingType' has a wrong offset!");
static_assert(offsetof(FHairLODSettings, Simulation) == 0x000018, "Member 'FHairLODSettings::Simulation' has a wrong offset!");
static_assert(offsetof(FHairLODSettings, GlobalInterpolation) == 0x000019, "Member 'FHairLODSettings::GlobalInterpolation' has a wrong offset!");
