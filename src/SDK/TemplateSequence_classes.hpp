...
public:
	...
	struct FCameraFocusSettings                   FocusSettings;                                     // 0x0790(0x0068)(NativeAccessSpecifierPublic)
...
static_assert(sizeof(UCameraAnimationSequenceCameraStandIn) == 0x000880, "Wrong size on UCameraAnimationSequenceCameraStandIn");
...
static_assert(offsetof(UCameraAnimationSequenceCameraStandIn, CurrentFocalLength) == 0x0007F8, "Member 'UCameraAnimationSequenceCameraStandIn::CurrentFocalLength' has a wrong offset!");
static_assert(offsetof(UCameraAnimationSequenceCameraStandIn, CurrentAperture) == 0x0007FC, "Member 'UCameraAnimationSequenceCameraStandIn::CurrentAperture' has a wrong offset!");
static_assert(offsetof(UCameraAnimationSequenceCameraStandIn, CurrentFocusDistance) == 0x000800, "Member 'UCameraAnimationSequenceCameraStandIn::CurrentFocusDistance' has a wrong offset!");
