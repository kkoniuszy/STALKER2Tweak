...
public:
	...
	uint8                                         Pad_598[0xF0];                                     // 0x0598(0x00F0)(Fixing Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(UEnhancedPlayerInput) == 0x000790, "Wrong size on UEnhancedPlayerInput");
...
// Class EnhancedInput.TriggerProgress
// 0x0000 (0x0028 - 0x0028)
class ITriggerProgress final : public IInterface
{
public:
	static class UClass* StaticClass()
	{
		return StaticClassImpl<"TriggerProgress">();
	}
	static class ITriggerProgress* GetDefaultObj()
	{
		return GetDefaultObjImpl<ITriggerProgress>();
	}
};
static_assert(alignof(ITriggerProgress) == 0x000008, "Wrong alignment on ITriggerProgress");
static_assert(sizeof(ITriggerProgress) == 0x000028, "Wrong size on ITriggerProgress");
...
// Class EnhancedInput.InputTriggerHoldWithActivationDelay
// 0x0010 (0x0068 - 0x0058)
class UInputTriggerHoldWithActivationDelay final : public UInputTriggerTimedBase
{
public:
	...
	float                                         HoldActivationThreshold;                           // 0x0064(0x0004)(Edit, BlueprintVisible, ZeroConstructor, Config, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)

public:
	static class UClass* StaticClass()
	{
		return StaticClassImpl<"InputTriggerHoldWithActivationDelay">();
	}
	static class UInputTriggerHoldWithActivationDelay* GetDefaultObj()
	{
		return GetDefaultObjImpl<UInputTriggerHoldWithActivationDelay>();
	}
};
static_assert(alignof(UInputTriggerHoldWithActivationDelay) == 0x000008, "Wrong alignment on UInputTriggerHoldWithActivationDelay");
static_assert(sizeof(UInputTriggerHoldWithActivationDelay) == 0x000068, "Wrong size on UInputTriggerHoldWithActivationDelay");
static_assert(offsetof(UInputTriggerHoldWithActivationDelay, HoldTimeThreshold) == 0x000060, "Member 'UInputTriggerHoldWithActivationDelay::HoldTimeThreshold' has a wrong offset!");
static_assert(offsetof(UInputTriggerHoldWithActivationDelay, HoldActivationThreshold) == 0x000064, "Member 'UInputTriggerHoldWithActivationDelay::HoldActivationThreshold' has a wrong offset!");
