...
{
public:
	class UWwiseAudioLinkSettings*                Settings;                                          // 0x04F0(0x0008)(Edit, BlueprintVisible, ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class USoundBase*                             Sound;                                             // 0x04F8(0x0008)(Edit, BlueprintVisible, ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bAutoPlay;                                         // 0x0500(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_501[0x7];                                      // 0x0501(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	class UAudioComponent*                        AudioComponent;                                    // 0x0508(0x0008)(ExportObject, ZeroConstructor, Transient, InstancedReference, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
...
static_assert(sizeof(UWwiseAudioLinkComponent) == 0x000520, "Wrong size on UWwiseAudioLinkComponent");
static_assert(offsetof(UWwiseAudioLinkComponent, Settings) == 0x0004F0, "Member 'UWwiseAudioLinkComponent::Settings' has a wrong offset!");
static_assert(offsetof(UWwiseAudioLinkComponent, Sound) == 0x0004F8, "Member 'UWwiseAudioLinkComponent::Sound' has a wrong offset!");
static_assert(offsetof(UWwiseAudioLinkComponent, bAutoPlay) == 0x000500, "Member 'UWwiseAudioLinkComponent::bAutoPlay' has a wrong offset!");
static_assert(offsetof(UWwiseAudioLinkComponent, AudioComponent) == 0x000508, "Member 'UWwiseAudioLinkComponent::AudioComponent' has a wrong offset!");
