...
// 0x0038 (0x0038 - 0x0000)
struct LandscapeProxy_EditorApplySplineGSC final
{
public:
	class USplineComponent*                       InSplineComponent;                                 // 0x0000(0x0008)(Parm, ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         StartWidth;                                        // 0x0008(0x0004)(Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(alignof(LandscapeProxy_EditorApplySplineGSC) == 0x000008, "Wrong alignment on LandscapeProxy_EditorApplySplineGSC");
static_assert(sizeof(LandscapeProxy_EditorApplySplineGSC) == 0x000038, "Wrong size on LandscapeProxy_EditorApplySplineGSC");
static_assert(offsetof(LandscapeProxy_EditorApplySplineGSC, InSplineComponent) == 0x000000, "Member 'LandscapeProxy_EditorApplySplineGSC::InSplineComponent' has a wrong offset!");
static_assert(offsetof(LandscapeProxy_EditorApplySplineGSC, StartWidth) == 0x000008, "Member 'LandscapeProxy_EditorApplySplineGSC::StartWidth' has a wrong offset!");
static_assert(offsetof(LandscapeProxy_EditorApplySplineGSC, EndWidth) == 0x00000C, "Member 'LandscapeProxy_EditorApplySplineGSC::EndWidth' has a wrong offset!");
static_assert(offsetof(LandscapeProxy_EditorApplySplineGSC, StartSideFalloff) == 0x000010, "Member 'LandscapeProxy_EditorApplySplineGSC::StartSideFalloff' has a wrong offset!");
static_assert(offsetof(LandscapeProxy_EditorApplySplineGSC, EndSideFalloff) == 0x000014, "Member 'LandscapeProxy_EditorApplySplineGSC::EndSideFalloff' has a wrong offset!");
static_assert(offsetof(LandscapeProxy_EditorApplySplineGSC, HeightOffset) == 0x000018, "Member 'LandscapeProxy_EditorApplySplineGSC::HeightOffset' has a wrong offset!");
static_assert(offsetof(LandscapeProxy_EditorApplySplineGSC, NumSubdivisions) == 0x00001C, "Member 'LandscapeProxy_EditorApplySplineGSC::NumSubdivisions' has a wrong offset!");
static_assert(offsetof(LandscapeProxy_EditorApplySplineGSC, bRaiseHeights) == 0x000020, "Member 'LandscapeProxy_EditorApplySplineGSC::bRaiseHeights' has a wrong offset!");
static_assert(offsetof(LandscapeProxy_EditorApplySplineGSC, bLowerHeights) == 0x000021, "Member 'LandscapeProxy_EditorApplySplineGSC::bLowerHeights' has a wrong offset!");
static_assert(offsetof(LandscapeProxy_EditorApplySplineGSC, PaintLayer) == 0x000028, "Member 'LandscapeProxy_EditorApplySplineGSC::PaintLayer' has a wrong offset!");
static_assert(offsetof(LandscapeProxy_EditorApplySplineGSC, EditLayerName) == 0x000030, "Member 'LandscapeProxy_EditorApplySplineGSC::EditLayerName' has a wrong offset!");
...
struct LandscapeProxy_EditorUndoApplySplineGSC final
{
public:
	class ULandscapeLayerInfoObject*              PaintLayer;                                        // 0x0000(0x0008)(Parm, ZeroConstructor, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class USplineComponent*                       InSplineComponent;                                 // 0x0008(0x0008)(Parm, ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
static_assert(alignof(LandscapeProxy_EditorUndoApplySplineGSC) == 0x000008, "Wrong alignment on LandscapeProxy_EditorUndoApplySplineGSC");
static_assert(sizeof(LandscapeProxy_EditorUndoApplySplineGSC) == 0x000010, "Wrong size on LandscapeProxy_EditorUndoApplySplineGSC");
static_assert(offsetof(LandscapeProxy_EditorUndoApplySplineGSC, PaintLayer) == 0x000000, "Member 'LandscapeProxy_EditorUndoApplySplineGSC::PaintLayer' has a wrong offset!");
static_assert(offsetof(LandscapeProxy_EditorUndoApplySplineGSC, InSplineComponent) == 0x000008, "Member 'LandscapeProxy_EditorUndoApplySplineGSC::InSplineComponent' has a wrong offset!");
