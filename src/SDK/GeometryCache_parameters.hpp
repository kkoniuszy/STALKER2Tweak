...
struct GeometryCacheComponent_SetDuration final
{
public:
...
static_assert(alignof(GeometryCacheComponent_SetDuration) == 0x000004, "Wrong alignment on GeometryCacheComponent_SetDuration");
static_assert(sizeof(GeometryCacheComponent_SetDuration) == 0x000004, "Wrong size on GeometryCacheComponent_SetDuration");
static_assert(offsetof(GeometryCacheComponent_SetDuration, NewDuration) == 0x000000, "Member 'GeometryCacheComponent_SetDuration::NewDuration' has a wrong offset!");
