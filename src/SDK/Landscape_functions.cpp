...
void ALandscapeProxy::EditorApplySplineGSC(class USplineComponent* InSplineComponent, float StartWidth, float EndWidth, float StartSideFalloff, float EndSideFalloff, float HeightOffset, int32 NumSubdivisions, bool bRaiseHeights, bool bLowerHeights, class ULandscapeLayerInfoObject* PaintLayer, class FName EditLayerName)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("LandscapeProxy", "EditorApplySplineGSC");

	Params::LandscapeProxy_EditorApplySplineGSC Parms{};
...
void ALandscapeProxy::EditorUndoApplySplineGSC(class ULandscapeLayerInfoObject* PaintLayer, class USplineComponent* InSplineComponent)
{
	...
	if (Func == nullptr)
		Func = Class->GetFunction("LandscapeProxy", "EditorUndoApplySplineGSC");

	Params::LandscapeProxy_EditorUndoApplySplineGSC Parms{};
