...
public:
	...
	struct FSlateBrush                            DefaultThrobberBrush;                              // 0x0110(0x00F0)(Transient, NativeAccessSpecifierPrivate)
	class UCommonUIRichTextData*                  RichTextDataInstance;                              // 0x0200(0x0008)(ZeroConstructor, Transient, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
...
static_assert(sizeof(UCommonUISettings) == 0x000210, "Wrong size on UCommonUISettings");
...
static_assert(offsetof(UCommonUISettings, RichTextDataInstance) == 0x000200, "Member 'UCommonUISettings::RichTextDataInstance' has a wrong offset!");
...
{
public:
	FMulticastInlineDelegateProperty_             OnAnalogCapture;                                   // 0x07C0(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
...
static_assert(sizeof(UAnalogSlider) == 0x0007E0, "Wrong size on UAnalogSlider");
static_assert(offsetof(UAnalogSlider, OnAnalogCapture) == 0x0007C0, "Member 'UAnalogSlider::OnAnalogCapture' has a wrong offset!");
...
public:
	...
	struct FSlateBrush                            VideoBrush;                                        // 0x0180(0x00F0)(Transient, NativeAccessSpecifierPrivate)
...
public:
	...
	struct FSlateBrush                            ProgressMaterialBrush;                             // 0x0160(0x00F0)(Edit, BlueprintVisible, NativeAccessSpecifierPublic)
	...
	struct FSlateBrush                            IconRimBrush;                                      // 0x0260(0x00F0)(Edit, BlueprintVisible, BlueprintReadOnly, NativeAccessSpecifierPublic)
	...
	class UMaterialInstanceDynamic*               ProgressDynamicMaterial;                           // 0x0368(0x0008)(ZeroConstructor, Transient, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	uint8                                         Pad_370[0x140];                                    // 0x0370(0x0140)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(UCommonActionWidget) == 0x0004B0, "Wrong size on UCommonActionWidget");
...
static_assert(offsetof(UCommonActionWidget, InputActions) == 0x000350, "Member 'UCommonActionWidget::InputActions' has a wrong offset!");
static_assert(offsetof(UCommonActionWidget, ProgressDynamicMaterial) == 0x000368, "Member 'UCommonActionWidget::ProgressDynamicMaterial' has a wrong offset!");
...
public:
	...
	struct FSlateBrush                            Background;                                        // 0x0030(0x00F0)(Edit, BlueprintVisible, BlueprintReadOnly, DisableEditOnInstance, NativeAccessSpecifierPublic)
...
static_assert(offsetof(UCommonBorder, Style) == 0x000328, "Member 'UCommonBorder::Style' has a wrong offset!");
static_assert(offsetof(UCommonBorder, bReducePaddingBySafezone) == 0x000330, "Member 'UCommonBorder::bReducePaddingBySafezone' has a wrong offset!");
static_assert(offsetof(UCommonBorder, MinimumPadding) == 0x000334, "Member 'UCommonBorder::MinimumPadding' has a wrong offset!");
...
public:
	...
	uint8                                         Pad_29[0x7];                                       // 0x0029(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	struct FSlateBrush                            SingleMaterialBrush;                               // 0x0030(0x00F0)(Edit, BlueprintVisible, BlueprintReadOnly, DisableEditOnInstance, NativeAccessSpecifierPublic)
	struct FSlateBrush                            NormalBase;                                        // 0x0120(0x00F0)(Edit, BlueprintVisible, BlueprintReadOnly, DisableEditOnInstance, NativeAccessSpecifierPublic)
	struct FSlateBrush                            NormalHovered;                                     // 0x0210(0x00F0)(Edit, BlueprintVisible, BlueprintReadOnly, DisableEditOnInstance, NativeAccessSpecifierPublic)
	struct FSlateBrush                            NormalPressed;                                     // 0x0300(0x00F0)(Edit, BlueprintVisible, BlueprintReadOnly, DisableEditOnInstance, NativeAccessSpecifierPublic)
	struct FSlateBrush                            SelectedBase;                                      // 0x03F0(0x00F0)(Edit, BlueprintVisible, BlueprintReadOnly, DisableEditOnInstance, NativeAccessSpecifierPublic)
	struct FSlateBrush                            SelectedHovered;                                   // 0x04E0(0x00F0)(Edit, BlueprintVisible, BlueprintReadOnly, DisableEditOnInstance, NativeAccessSpecifierPublic)
	struct FSlateBrush                            SelectedPressed;                                   // 0x05D0(0x00F0)(Edit, BlueprintVisible, BlueprintReadOnly, DisableEditOnInstance, NativeAccessSpecifierPublic)
	struct FSlateBrush                            Disabled;                                          // 0x06C0(0x00F0)(Edit, BlueprintVisible, BlueprintReadOnly, DisableEditOnInstance, NativeAccessSpecifierPublic)
	struct FMargin                                ButtonPadding;                                     // 0x07B0(0x0010)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, NativeAccessSpecifierPublic)
	struct FMargin                                CustomPadding;                                     // 0x07C0(0x0010)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, NativeAccessSpecifierPublic)
	int32                                         MinWidth;                                          // 0x07D0(0x0004)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	int32                                         MinHeight;                                         // 0x07D4(0x0004)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	TSubclassOf<class UCommonTextStyle>           NormalTextStyle;                                   // 0x07D8(0x0008)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, DisableEditOnInstance, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	TSubclassOf<class UCommonTextStyle>           NormalHoveredTextStyle;                            // 0x07E0(0x0008)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, DisableEditOnInstance, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	TSubclassOf<class UCommonTextStyle>           SelectedTextStyle;                                 // 0x07E8(0x0008)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, DisableEditOnInstance, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	TSubclassOf<class UCommonTextStyle>           SelectedHoveredTextStyle;                          // 0x07F0(0x0008)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, DisableEditOnInstance, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	TSubclassOf<class UCommonTextStyle>           DisabledTextStyle;                                 // 0x07F8(0x0008)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, DisableEditOnInstance, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FSlateSound                            PressedSlateSound;                                 // 0x0800(0x0018)(Edit, BlueprintVisible, BlueprintReadOnly, DisableEditOnInstance, NoDestructor, NativeAccessSpecifierPublic)
	struct FCommonButtonStyleOptionalSlateSound   SelectedPressedSlateSound;                         // 0x0818(0x0020)(Edit, BlueprintVisible, BlueprintReadOnly, DisableEditOnInstance, NoDestructor, NativeAccessSpecifierPublic)
	struct FCommonButtonStyleOptionalSlateSound   LockedPressedSlateSound;                           // 0x0838(0x0020)(Edit, BlueprintVisible, BlueprintReadOnly, DisableEditOnInstance, NoDestructor, NativeAccessSpecifierPublic)
	struct FSlateSound                            HoveredSlateSound;                                 // 0x0858(0x0018)(Edit, BlueprintVisible, BlueprintReadOnly, DisableEditOnInstance, NoDestructor, NativeAccessSpecifierPublic)
	struct FCommonButtonStyleOptionalSlateSound   SelectedHoveredSlateSound;                         // 0x0870(0x0020)(Edit, BlueprintVisible, BlueprintReadOnly, DisableEditOnInstance, NoDestructor, NativeAccessSpecifierPublic)
	struct FCommonButtonStyleOptionalSlateSound   LockedHoveredSlateSound;                           // 0x0890(0x0020)(Edit, BlueprintVisible, BlueprintReadOnly, DisableEditOnInstance, NoDestructor, NativeAccessSpecifierPublic)
...
static_assert(sizeof(UCommonButtonStyle) == 0x0008B0, "Wrong size on UCommonButtonStyle");
...
static_assert(offsetof(UCommonButtonStyle, NormalHovered) == 0x000210, "Member 'UCommonButtonStyle::NormalHovered' has a wrong offset!");
static_assert(offsetof(UCommonButtonStyle, NormalPressed) == 0x000300, "Member 'UCommonButtonStyle::NormalPressed' has a wrong offset!");
static_assert(offsetof(UCommonButtonStyle, SelectedBase) == 0x0003F0, "Member 'UCommonButtonStyle::SelectedBase' has a wrong offset!");
static_assert(offsetof(UCommonButtonStyle, SelectedHovered) == 0x0004E0, "Member 'UCommonButtonStyle::SelectedHovered' has a wrong offset!");
static_assert(offsetof(UCommonButtonStyle, SelectedPressed) == 0x0005D0, "Member 'UCommonButtonStyle::SelectedPressed' has a wrong offset!");
static_assert(offsetof(UCommonButtonStyle, Disabled) == 0x0006C0, "Member 'UCommonButtonStyle::Disabled' has a wrong offset!");
static_assert(offsetof(UCommonButtonStyle, ButtonPadding) == 0x0007B0, "Member 'UCommonButtonStyle::ButtonPadding' has a wrong offset!");
static_assert(offsetof(UCommonButtonStyle, CustomPadding) == 0x0007C0, "Member 'UCommonButtonStyle::CustomPadding' has a wrong offset!");
static_assert(offsetof(UCommonButtonStyle, MinWidth) == 0x0007D0, "Member 'UCommonButtonStyle::MinWidth' has a wrong offset!");
static_assert(offsetof(UCommonButtonStyle, MinHeight) == 0x0007D4, "Member 'UCommonButtonStyle::MinHeight' has a wrong offset!");
static_assert(offsetof(UCommonButtonStyle, NormalTextStyle) == 0x0007D8, "Member 'UCommonButtonStyle::NormalTextStyle' has a wrong offset!");
static_assert(offsetof(UCommonButtonStyle, NormalHoveredTextStyle) == 0x0007E0, "Member 'UCommonButtonStyle::NormalHoveredTextStyle' has a wrong offset!");
static_assert(offsetof(UCommonButtonStyle, SelectedTextStyle) == 0x0007E8, "Member 'UCommonButtonStyle::SelectedTextStyle' has a wrong offset!");
static_assert(offsetof(UCommonButtonStyle, SelectedHoveredTextStyle) == 0x0007F0, "Member 'UCommonButtonStyle::SelectedHoveredTextStyle' has a wrong offset!");
static_assert(offsetof(UCommonButtonStyle, DisabledTextStyle) == 0x0007F8, "Member 'UCommonButtonStyle::DisabledTextStyle' has a wrong offset!");
static_assert(offsetof(UCommonButtonStyle, PressedSlateSound) == 0x000800, "Member 'UCommonButtonStyle::PressedSlateSound' has a wrong offset!");
static_assert(offsetof(UCommonButtonStyle, SelectedPressedSlateSound) == 0x000818, "Member 'UCommonButtonStyle::SelectedPressedSlateSound' has a wrong offset!");
static_assert(offsetof(UCommonButtonStyle, LockedPressedSlateSound) == 0x000838, "Member 'UCommonButtonStyle::LockedPressedSlateSound' has a wrong offset!");
static_assert(offsetof(UCommonButtonStyle, HoveredSlateSound) == 0x000858, "Member 'UCommonButtonStyle::HoveredSlateSound' has a wrong offset!");
static_assert(offsetof(UCommonButtonStyle, SelectedHoveredSlateSound) == 0x000870, "Member 'UCommonButtonStyle::SelectedHoveredSlateSound' has a wrong offset!");
static_assert(offsetof(UCommonButtonStyle, LockedHoveredSlateSound) == 0x000890, "Member 'UCommonButtonStyle::LockedHoveredSlateSound' has a wrong offset!");
...
public:
	...
	FMulticastInlineDelegateProperty_             OnDoubleClicked;                                   // 0x0678(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	uint8                                         Pad_688[0x20];                                     // 0x0688(0x0020)(Fixing Size After Last Property [ Dumper-7 ])
	int32                                         MinWidth;                                          // 0x06A8(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	int32                                         MinHeight;                                         // 0x06AC(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	bool                                          bButtonEnabled;                                    // 0x06B0(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	bool                                          bInteractionEnabled;                               // 0x06B1(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	uint8                                         Pad_6B2[0x2E];                                     // 0x06B2(0x002E)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(UCommonButtonInternalBase) == 0x0006E0, "Wrong size on UCommonButtonInternalBase");
static_assert(offsetof(UCommonButtonInternalBase, OnDoubleClicked) == 0x000678, "Member 'UCommonButtonInternalBase::OnDoubleClicked' has a wrong offset!");
static_assert(offsetof(UCommonButtonInternalBase, MinWidth) == 0x0006A8, "Member 'UCommonButtonInternalBase::MinWidth' has a wrong offset!");
static_assert(offsetof(UCommonButtonInternalBase, MinHeight) == 0x0006AC, "Member 'UCommonButtonInternalBase::MinHeight' has a wrong offset!");
static_assert(offsetof(UCommonButtonInternalBase, bButtonEnabled) == 0x0006B0, "Member 'UCommonButtonInternalBase::bButtonEnabled' has a wrong offset!");
static_assert(offsetof(UCommonButtonInternalBase, bInteractionEnabled) == 0x0006B1, "Member 'UCommonButtonInternalBase::bInteractionEnabled' has a wrong offset!");
...
public:
	...
	struct FButtonStyle                           NormalStyle;                                       // 0x0410(0x0470)(NativeAccessSpecifierPrivate)
	struct FButtonStyle                           SelectedStyle;                                     // 0x0880(0x0470)(NativeAccessSpecifierPrivate)
	struct FButtonStyle                           DisabledStyle;                                     // 0x0CF0(0x0470)(NativeAccessSpecifierPrivate)
	struct FButtonStyle                           LockedStyle;                                       // 0x1160(0x0470)(NativeAccessSpecifierPrivate)
	uint8                                         bStopDoubleClickPropagation : 1;                   // 0x15D0(0x0001)(BitIndex: 0x00, PropSize: 0x0001 (Transient, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate))
	uint8                                         Pad_15D1[0x117];                                   // 0x15D1(0x0117)(Fixing Size After Last Property [ Dumper-7 ])
	class UCommonActionWidget*                    InputActionWidget;                                 // 0x16E8(0x0008)(BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, InstancedReference, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
...
static_assert(sizeof(UCommonButtonBase) == 0x0016F0, "Wrong size on UCommonButtonBase");
...
static_assert(offsetof(UCommonButtonBase, SelectedStyle) == 0x000880, "Member 'UCommonButtonBase::SelectedStyle' has a wrong offset!");
static_assert(offsetof(UCommonButtonBase, DisabledStyle) == 0x000CF0, "Member 'UCommonButtonBase::DisabledStyle' has a wrong offset!");
static_assert(offsetof(UCommonButtonBase, LockedStyle) == 0x001160, "Member 'UCommonButtonBase::LockedStyle' has a wrong offset!");
static_assert(offsetof(UCommonButtonBase, InputActionWidget) == 0x0016E8, "Member 'UCommonButtonBase::InputActionWidget' has a wrong offset!");
...
static_assert(offsetof(UCommonCustomNavigation, OnNavigationEvent) == 0x000328, "Member 'UCommonCustomNavigation::OnNavigationEvent' has a wrong offset!");
...
{
public:
	TSubclassOf<class UCommonTextStyle>           Style;                                             // 0x0358(0x0008)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, NoDestructor, ExposeOnSpawn, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	TSubclassOf<class UCommonTextScrollStyle>     ScrollStyle;                                       // 0x0360(0x0008)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, NoDestructor, ExposeOnSpawn, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	class UCommonStyleSheet*                      StyleSheet;                                        // 0x0368(0x0008)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, NoDestructor, AdvancedDisplay, ExposeOnSpawn, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	bool                                          bIsScrollingEnabled;                               // 0x0370(0x0001)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, ExposeOnSpawn, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	bool                                          bDisplayAllCaps;                                   // 0x0371(0x0001)(ZeroConstructor, Deprecated, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	bool                                          bAutoCollapseWithEmptyText;                        // 0x0372(0x0001)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	uint8                                         Pad_373[0x1];                                      // 0x0373(0x0001)(Fixing Size After Last Property [ Dumper-7 ])
	float                                         MobileFontSizeMultiplier;                          // 0x0374(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
...
static_assert(sizeof(UCommonTextBlock) == 0x000390, "Wrong size on UCommonTextBlock");
static_assert(offsetof(UCommonTextBlock, Style) == 0x000358, "Member 'UCommonTextBlock::Style' has a wrong offset!");
static_assert(offsetof(UCommonTextBlock, ScrollStyle) == 0x000360, "Member 'UCommonTextBlock::ScrollStyle' has a wrong offset!");
static_assert(offsetof(UCommonTextBlock, StyleSheet) == 0x000368, "Member 'UCommonTextBlock::StyleSheet' has a wrong offset!");
static_assert(offsetof(UCommonTextBlock, bIsScrollingEnabled) == 0x000370, "Member 'UCommonTextBlock::bIsScrollingEnabled' has a wrong offset!");
static_assert(offsetof(UCommonTextBlock, bDisplayAllCaps) == 0x000371, "Member 'UCommonTextBlock::bDisplayAllCaps' has a wrong offset!");
static_assert(offsetof(UCommonTextBlock, bAutoCollapseWithEmptyText) == 0x000372, "Member 'UCommonTextBlock::bAutoCollapseWithEmptyText' has a wrong offset!");
static_assert(offsetof(UCommonTextBlock, MobileFontSizeMultiplier) == 0x000374, "Member 'UCommonTextBlock::MobileFontSizeMultiplier' has a wrong offset!");
...
static_assert(sizeof(UCommonDateTimeTextBlock) == 0x0003E0, "Wrong size on UCommonDateTimeTextBlock");
...
static_assert(sizeof(UCommonHardwareVisibilityBorder) == 0x0003A0, "Wrong size on UCommonHardwareVisibilityBorder");
static_assert(offsetof(UCommonHardwareVisibilityBorder, VisibilityQuery) == 0x000348, "Member 'UCommonHardwareVisibilityBorder::VisibilityQuery' has a wrong offset!");
static_assert(offsetof(UCommonHardwareVisibilityBorder, VisibleType) == 0x000390, "Member 'UCommonHardwareVisibilityBorder::VisibleType' has a wrong offset!");
static_assert(offsetof(UCommonHardwareVisibilityBorder, HiddenType) == 0x000391, "Member 'UCommonHardwareVisibilityBorder::HiddenType' has a wrong offset!");
...
static_assert(sizeof(UCommonHierarchicalScrollBox) == 0x000E40, "Wrong size on UCommonHierarchicalScrollBox");
...
{
public:
	struct FSlateBrush                            LoadingBackgroundBrush;                            // 0x02D0(0x00F0)(Edit, NativeAccessSpecifierPrivate)
	...
	FMulticastInlineDelegateProperty_             BP_OnLoadingStateChanged;                          // 0x03C8(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPrivate)
...
static_assert(offsetof(UCommonLazyImage, LoadingBackgroundBrush) == 0x0002D0, "Member 'UCommonLazyImage::LoadingBackgroundBrush' has a wrong offset!");
static_assert(offsetof(UCommonLazyImage, MaterialTextureParamName) == 0x0003C0, "Member 'UCommonLazyImage::MaterialTextureParamName' has a wrong offset!");
static_assert(offsetof(UCommonLazyImage, BP_OnLoadingStateChanged) == 0x0003C8, "Member 'UCommonLazyImage::BP_OnLoadingStateChanged' has a wrong offset!");
...
{
public:
	struct FSlateBrush                            LoadingBackgroundBrush;                            // 0x0150(0x00F0)(Edit, NativeAccessSpecifierPrivate)
...
static_assert(offsetof(UCommonLazyWidget, BP_OnLoadingStateChanged) == 0x000278, "Member 'UCommonLazyWidget::BP_OnLoadingStateChanged' has a wrong offset!");
...
public:
	...
	struct FSlateBrush                            LoadingBackgroundBrush;                            // 0x0170(0x00F0)(Edit, NativeAccessSpecifierPrivate)
	...
	class FText                                   LoadingText;                                       // 0x0278(0x0018)(Edit, NativeAccessSpecifierPrivate)
	TSubclassOf<class UCommonTextStyle>           TextStyle;                                         // 0x0290(0x0008)(Edit, ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	FMulticastInlineDelegateProperty_             BP_OnLoadingStateChanged;                          // 0x0298(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPrivate)
	struct FSoftObjectPath                        SpinnerMaterialPath;                               // 0x02A8(0x0020)(ZeroConstructor, Config, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
...
static_assert(offsetof(UCommonLoadGuard, TextStyle) == 0x000290, "Member 'UCommonLoadGuard::TextStyle' has a wrong offset!");
static_assert(offsetof(UCommonLoadGuard, BP_OnLoadingStateChanged) == 0x000298, "Member 'UCommonLoadGuard::BP_OnLoadingStateChanged' has a wrong offset!");
static_assert(offsetof(UCommonLoadGuard, SpinnerMaterialPath) == 0x0002A8, "Member 'UCommonLoadGuard::SpinnerMaterialPath' has a wrong offset!");
...
{
public:
	FMulticastInlineDelegateProperty_             OnInterpolationStartedEvent;                       // 0x0388(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	FMulticastInlineDelegateProperty_             OnInterpolationUpdatedEvent;                       // 0x0398(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	FMulticastInlineDelegateProperty_             OnOutroEvent;                                      // 0x03A8(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	FMulticastInlineDelegateProperty_             OnInterpolationEndedEvent;                         // 0x03B8(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
...
static_assert(sizeof(UCommonNumericTextBlock) == 0x000430, "Wrong size on UCommonNumericTextBlock");
static_assert(offsetof(UCommonNumericTextBlock, OnInterpolationStartedEvent) == 0x000388, "Member 'UCommonNumericTextBlock::OnInterpolationStartedEvent' has a wrong offset!");
static_assert(offsetof(UCommonNumericTextBlock, OnInterpolationUpdatedEvent) == 0x000398, "Member 'UCommonNumericTextBlock::OnInterpolationUpdatedEvent' has a wrong offset!");
static_assert(offsetof(UCommonNumericTextBlock, OnOutroEvent) == 0x0003A8, "Member 'UCommonNumericTextBlock::OnOutroEvent' has a wrong offset!");
static_assert(offsetof(UCommonNumericTextBlock, OnInterpolationEndedEvent) == 0x0003B8, "Member 'UCommonNumericTextBlock::OnInterpolationEndedEvent' has a wrong offset!");
static_assert(offsetof(UCommonNumericTextBlock, CurrentNumericValue) == 0x0003C8, "Member 'UCommonNumericTextBlock::CurrentNumericValue' has a wrong offset!");
static_assert(offsetof(UCommonNumericTextBlock, NumericType) == 0x0003CC, "Member 'UCommonNumericTextBlock::NumericType' has a wrong offset!");
static_assert(offsetof(UCommonNumericTextBlock, FormattingSpecification) == 0x0003D0, "Member 'UCommonNumericTextBlock::FormattingSpecification' has a wrong offset!");
static_assert(offsetof(UCommonNumericTextBlock, EaseOutInterpolationExponent) == 0x0003E4, "Member 'UCommonNumericTextBlock::EaseOutInterpolationExponent' has a wrong offset!");
static_assert(offsetof(UCommonNumericTextBlock, InterpolationUpdateInterval) == 0x0003E8, "Member 'UCommonNumericTextBlock::InterpolationUpdateInterval' has a wrong offset!");
static_assert(offsetof(UCommonNumericTextBlock, PostInterpolationShrinkDuration) == 0x0003EC, "Member 'UCommonNumericTextBlock::PostInterpolationShrinkDuration' has a wrong offset!");
static_assert(offsetof(UCommonNumericTextBlock, PerformSizeInterpolation) == 0x0003F0, "Member 'UCommonNumericTextBlock::PerformSizeInterpolation' has a wrong offset!");
static_assert(offsetof(UCommonNumericTextBlock, IsPercentage) == 0x0003F1, "Member 'UCommonNumericTextBlock::IsPercentage' has a wrong offset!");
...
{
public:
	ERichTextInlineIconDisplayMode                InlineIconDisplayMode;                             // 0x0930(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bTintInlineIcon;                                   // 0x0931(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_932[0x6];                                      // 0x0932(0x0006)(Fixing Size After Last Property [ Dumper-7 ])
	TSubclassOf<class UCommonTextStyle>           DefaultTextStyleOverrideClass;                     // 0x0938(0x0008)(Edit, ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	float                                         MobileTextBlockScale;                              // 0x0940(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	uint8                                         Pad_944[0x4];                                      // 0x0944(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	TSubclassOf<class UCommonTextScrollStyle>     ScrollStyle;                                       // 0x0948(0x0008)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, NoDestructor, ExposeOnSpawn, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	bool                                          bIsScrollingEnabled;                               // 0x0950(0x0001)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, ExposeOnSpawn, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	bool                                          bDisplayAllCaps;                                   // 0x0951(0x0001)(ZeroConstructor, Deprecated, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	bool                                          bAutoCollapseWithEmptyText;                        // 0x0952(0x0001)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	uint8                                         Pad_953[0x15];                                     // 0x0953(0x0015)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(UCommonRichTextBlock) == 0x000970, "Wrong size on UCommonRichTextBlock");
static_assert(offsetof(UCommonRichTextBlock, InlineIconDisplayMode) == 0x000930, "Member 'UCommonRichTextBlock::InlineIconDisplayMode' has a wrong offset!");
static_assert(offsetof(UCommonRichTextBlock, bTintInlineIcon) == 0x000931, "Member 'UCommonRichTextBlock::bTintInlineIcon' has a wrong offset!");
static_assert(offsetof(UCommonRichTextBlock, DefaultTextStyleOverrideClass) == 0x000938, "Member 'UCommonRichTextBlock::DefaultTextStyleOverrideClass' has a wrong offset!");
static_assert(offsetof(UCommonRichTextBlock, MobileTextBlockScale) == 0x000940, "Member 'UCommonRichTextBlock::MobileTextBlockScale' has a wrong offset!");
static_assert(offsetof(UCommonRichTextBlock, ScrollStyle) == 0x000948, "Member 'UCommonRichTextBlock::ScrollStyle' has a wrong offset!");
static_assert(offsetof(UCommonRichTextBlock, bIsScrollingEnabled) == 0x000950, "Member 'UCommonRichTextBlock::bIsScrollingEnabled' has a wrong offset!");
static_assert(offsetof(UCommonRichTextBlock, bDisplayAllCaps) == 0x000951, "Member 'UCommonRichTextBlock::bDisplayAllCaps' has a wrong offset!");
static_assert(offsetof(UCommonRichTextBlock, bAutoCollapseWithEmptyText) == 0x000952, "Member 'UCommonRichTextBlock::bAutoCollapseWithEmptyText' has a wrong offset!");
...
{
public:
	uint8                                         Pad_16F0[0x10];                                    // 0x16F0(0x0010)(Fixing Size After Last Property [ Dumper-7 ])
	FMulticastInlineDelegateProperty_             OnRotated;                                         // 0x1700(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	uint8                                         Pad_1710[0x18];                                    // 0x1710(0x0018)(Fixing Size After Last Property [ Dumper-7 ])
	class UCommonTextBlock*                       MyText;                                            // 0x1728(0x0008)(BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, InstancedReference, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	uint8                                         Pad_1730[0x20];                                    // 0x1730(0x0020)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(UCommonRotator) == 0x001750, "Wrong size on UCommonRotator");
static_assert(offsetof(UCommonRotator, OnRotated) == 0x001700, "Member 'UCommonRotator::OnRotated' has a wrong offset!");
static_assert(offsetof(UCommonRotator, MyText) == 0x001728, "Member 'UCommonRotator::MyText' has a wrong offset!");
...
public:
	...
	struct FSlateBrush                            StrikeBrush;                                       // 0x00D0(0x00F0)(Edit, BlueprintVisible, BlueprintReadOnly, DisableEditOnInstance, NativeAccessSpecifierPublic)
...
static_assert(sizeof(UUCommonVisibilityWidgetBase) == 0x0003A0, "Wrong size on UUCommonVisibilityWidgetBase");
static_assert(offsetof(UUCommonVisibilityWidgetBase, VisibilityControls) == 0x000348, "Member 'UUCommonVisibilityWidgetBase::VisibilityControls' has a wrong offset!");
static_assert(offsetof(UUCommonVisibilityWidgetBase, bShowForGamepad) == 0x000398, "Member 'UUCommonVisibilityWidgetBase::bShowForGamepad' has a wrong offset!");
static_assert(offsetof(UUCommonVisibilityWidgetBase, bShowForMouseAndKeyboard) == 0x000399, "Member 'UUCommonVisibilityWidgetBase::bShowForMouseAndKeyboard' has a wrong offset!");
static_assert(offsetof(UUCommonVisibilityWidgetBase, bShowForTouch) == 0x00039A, "Member 'UUCommonVisibilityWidgetBase::bShowForTouch' has a wrong offset!");
static_assert(offsetof(UUCommonVisibilityWidgetBase, VisibleType) == 0x00039B, "Member 'UUCommonVisibilityWidgetBase::VisibleType' has a wrong offset!");
static_assert(offsetof(UUCommonVisibilityWidgetBase, HiddenType) == 0x00039C, "Member 'UUCommonVisibilityWidgetBase::HiddenType' has a wrong offset!");
...
public:
	...
	class UCommonTextBlock*                       Text_ActionName;                                   // 0x16F8(0x0008)(BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, InstancedReference, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
...
static_assert(sizeof(UCommonBoundActionButton) == 0x001710, "Wrong size on UCommonBoundActionButton");
static_assert(offsetof(UCommonBoundActionButton, Text_ActionName) == 0x0016F8, "Member 'UCommonBoundActionButton::Text_ActionName' has a wrong offset!");
