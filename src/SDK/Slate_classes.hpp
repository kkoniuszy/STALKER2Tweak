...
{
public:
	struct FButtonStyle                           ButtonStyle;                                       // 0x0030(0x0470)(Edit, BlueprintVisible, NativeAccessSpecifierPublic)
...
static_assert(sizeof(UButtonWidgetStyle) == 0x0004A0, "Wrong size on UButtonWidgetStyle");
...
// 0x0C50 (0x0C80 - 0x0030)
class UCheckBoxWidgetStyle final : public USlateWidgetStyleContainerBase
{
public:
	struct FCheckBoxStyle                         CheckBoxStyle;                                     // 0x0030(0x0C50)(Edit, NativeAccessSpecifierPublic)
...
static_assert(sizeof(UCheckBoxWidgetStyle) == 0x000C80, "Wrong size on UCheckBoxWidgetStyle");
...
{
public:
	struct FComboBoxStyle                         ComboBoxStyle;                                     // 0x0030(0x0720)(Edit, NativeAccessSpecifierPublic)
...
static_assert(sizeof(UComboBoxWidgetStyle) == 0x000750, "Wrong size on UComboBoxWidgetStyle");
...
{
public:
	struct FComboButtonStyle                      ComboButtonStyle;                                  // 0x0030(0x06C0)(Edit, NativeAccessSpecifierPublic)
...
static_assert(sizeof(UComboButtonWidgetStyle) == 0x0006F0, "Wrong size on UComboButtonWidgetStyle");
...
// 0x1080 (0x10B0 - 0x0030)
class UEditableTextBoxWidgetStyle final : public USlateWidgetStyleContainerBase
{
public:
	struct FEditableTextBoxStyle                  EditableTextBoxStyle;                              // 0x0030(0x1080)(Edit, NativeAccessSpecifierPublic)
...
static_assert(sizeof(UEditableTextBoxWidgetStyle) == 0x0010B0, "Wrong size on UEditableTextBoxWidgetStyle");
...
{
public:
	struct FEditableTextStyle                     EditableTextStyle;                                 // 0x0030(0x0350)(Edit, NativeAccessSpecifierPublic)
...
static_assert(sizeof(UEditableTextWidgetStyle) == 0x000380, "Wrong size on UEditableTextWidgetStyle");
...
{
public:
	struct FProgressBarStyle                      ProgressBarStyle;                                  // 0x0030(0x02F0)(Edit, BlueprintVisible, NativeAccessSpecifierPublic)
...
static_assert(sizeof(UProgressWidgetStyle) == 0x000320, "Wrong size on UProgressWidgetStyle");
...
{
public:
	struct FScrollBarStyle                        ScrollBarStyle;                                    // 0x0030(0x0890)(Edit, NativeAccessSpecifierPublic)
...
static_assert(sizeof(UScrollBarWidgetStyle) == 0x0008C0, "Wrong size on UScrollBarWidgetStyle");
...
{
public:
	struct FScrollBoxStyle                        ScrollBoxStyle;                                    // 0x0030(0x03D0)(Edit, NativeAccessSpecifierPublic)
...
static_assert(sizeof(UScrollBoxWidgetStyle) == 0x000400, "Wrong size on UScrollBoxWidgetStyle");
...
{
public:
	struct FSpinBoxStyle                          SpinBoxStyle;                                      // 0x0030(0x06E0)(Edit, NativeAccessSpecifierPublic)
...
static_assert(sizeof(USpinBoxWidgetStyle) == 0x000710, "Wrong size on USpinBoxWidgetStyle");
...
{
public:
	struct FTextBlockStyle                        TextBlockStyle;                                    // 0x0030(0x03A0)(Edit, NativeAccessSpecifierPublic)
...
static_assert(sizeof(UTextBlockWidgetStyle) == 0x0003D0, "Wrong size on UTextBlockWidgetStyle");
