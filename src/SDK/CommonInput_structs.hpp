...
public:
	...
	struct FSlateBrush                            KeyBrush;                                          // 0x0020(0x00F0)(Edit, NativeAccessSpecifierPublic)
};
static_assert(alignof(FCommonInputKeyBrushConfiguration) == 0x000010, "Wrong alignment on FCommonInputKeyBrushConfiguration");
static_assert(sizeof(FCommonInputKeyBrushConfiguration) == 0x000110, "Wrong size on FCommonInputKeyBrushConfiguration");
...
public:
	...
	struct FSlateBrush                            KeyBrush;                                          // 0x0010(0x00F0)(Edit, NativeAccessSpecifierPublic)
};
...
static_assert(sizeof(FCommonInputKeySetBrushConfiguration) == 0x000100, "Wrong size on FCommonInputKeySetBrushConfiguration");
