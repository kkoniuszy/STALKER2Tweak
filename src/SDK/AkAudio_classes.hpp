...
{
public:
	uint8                                         Pad_2B8[0x3];                                      // 0x02B8(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	bool                                          bUseSpatialAudio;                                  // 0x02BB(0x0001)(ZeroConstructor, Deprecated, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	...
	uint8                                         Pad_2FA[0x1F6];                                    // 0x02FA(0x01F6)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(UAkComponent) == 0x0004F0, "Wrong size on UAkComponent");
static_assert(offsetof(UAkComponent, bUseSpatialAudio) == 0x0002BB, "Member 'UAkComponent::bUseSpatialAudio' has a wrong offset!");
...
public:
	...
	uint8                                         Pad_2AD[0x203];                                    // 0x02AD(0x0203)(Fixing Size After Last Property [ Dumper-7 ])
	class UTextRenderComponent*                   FrontRoomText;                                     // 0x04B0(0x0008)(ExportObject, ZeroConstructor, InstancedReference, NonTransactional, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	class UTextRenderComponent*                   BackRoomText;                                      // 0x04B8(0x0008)(ExportObject, ZeroConstructor, InstancedReference, NonTransactional, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
...
static_assert(offsetof(UAkPortalComponent, FrontRoomText) == 0x0004B0, "Member 'UAkPortalComponent::FrontRoomText' has a wrong offset!");
static_assert(offsetof(UAkPortalComponent, BackRoomText) == 0x0004B8, "Member 'UAkPortalComponent::BackRoomText' has a wrong offset!");
...
static_assert(sizeof(UAkAudioInputComponent) == 0x000520, "Wrong size on UAkAudioInputComponent");
...
public:
	...
	struct FCheckBoxStyle                         WidgetStyle;                                       // 0x0410(0x0C50)(Edit, BlueprintVisible, NativeAccessSpecifierPublic)
	EHorizontalAlignment                          HorizontalAlignment;                               // 0x1060(0x0001)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          IsFocusable;                                       // 0x1061(0x0001)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_1062[0x6];                                     // 0x1062(0x0006)(Fixing Size After Last Property [ Dumper-7 ])
	struct FAkBoolPropertyToControl               ThePropertyToControl;                              // 0x1068(0x0010)(Edit, NativeAccessSpecifierPublic)
	struct FAkWwiseItemToControl                  ItemToControl;                                     // 0x1078(0x0040)(Edit, Config, EditConst, NativeAccessSpecifierPublic)
	TMulticastInlineDelegate<void(bool bIsChecked)> AkOnCheckStateChanged;                             // 0x10B8(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	TMulticastInlineDelegate<void(const struct FGuid& ItemDroppedID)> OnItemDropped;                                     // 0x10C8(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	TMulticastInlineDelegate<void(const class FString& PropertyDropped)> OnPropertyDropped;                                 // 0x10D8(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	uint8                                         Pad_10E8[0x58];                                    // 0x10E8(0x0058)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(UAkCheckBox) == 0x001140, "Wrong size on UAkCheckBox");
...
static_assert(offsetof(UAkCheckBox, HorizontalAlignment) == 0x001060, "Member 'UAkCheckBox::HorizontalAlignment' has a wrong offset!");
static_assert(offsetof(UAkCheckBox, IsFocusable) == 0x001061, "Member 'UAkCheckBox::IsFocusable' has a wrong offset!");
static_assert(offsetof(UAkCheckBox, ThePropertyToControl) == 0x001068, "Member 'UAkCheckBox::ThePropertyToControl' has a wrong offset!");
static_assert(offsetof(UAkCheckBox, ItemToControl) == 0x001078, "Member 'UAkCheckBox::ItemToControl' has a wrong offset!");
static_assert(offsetof(UAkCheckBox, AkOnCheckStateChanged) == 0x0010B8, "Member 'UAkCheckBox::AkOnCheckStateChanged' has a wrong offset!");
static_assert(offsetof(UAkCheckBox, OnItemDropped) == 0x0010C8, "Member 'UAkCheckBox::OnItemDropped' has a wrong offset!");
static_assert(offsetof(UAkCheckBox, OnPropertyDropped) == 0x0010D8, "Member 'UAkCheckBox::OnPropertyDropped' has a wrong offset!");
...
{
public:
	class UAkAudioEvent*                          AkBeginOverlapAudioEvent;                          // 0x02B8(0x0008)(Edit, BlueprintVisible, ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class UAkAudioEvent*                          AkEndOverlapAudioEvent;                            // 0x02C0(0x0008)(Edit, BlueprintVisible, ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bIgnoreVolumeExtensionCollisions;                  // 0x02C8(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bEnable;                                           // 0x02C9(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bDynamic;                                          // 0x02CA(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	...
	float                                         WallOcclusion;                                     // 0x02D0(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         AuxSendLevel;                                      // 0x02D4(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          AutoPost;                                          // 0x02D8(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, SimpleDisplay, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bEnableReverbZone;                                 // 0x02D9(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_2DA[0x6];                                      // 0x02DA(0x0006)(Fixing Size After Last Property [ Dumper-7 ])
	class AActor*                                 ParentRoomActor;                                   // 0x02E0(0x0008)(Edit, BlueprintVisible, ZeroConstructor, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class FString                                 ParentRoomName;                                    // 0x02E8(0x0010)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, EditConst, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         TransitionRegionWidth;                             // 0x02F8(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_2FC[0xC];                                      // 0x02FC(0x000C)(Fixing Size After Last Property [ Dumper-7 ])
	class UAkAcousticTextureSetComponent*         GeometryComponent;                                 // 0x0308(0x0008)(ExportObject, ZeroConstructor, Transient, InstancedReference, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	uint8                                         Pad_310[0x58];                                     // 0x0310(0x0058)(Fixing Size After Last Property [ Dumper-7 ])
	TWeakObjectPtr<class UAkRoomComponent>        ParentRoom;                                        // 0x0368(0x0008)(ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
...
static_assert(offsetof(UAkRoomComponent, AkBeginOverlapAudioEvent) == 0x0002B8, "Member 'UAkRoomComponent::AkBeginOverlapAudioEvent' has a wrong offset!");
static_assert(offsetof(UAkRoomComponent, AkEndOverlapAudioEvent) == 0x0002C0, "Member 'UAkRoomComponent::AkEndOverlapAudioEvent' has a wrong offset!");
static_assert(offsetof(UAkRoomComponent, bIgnoreVolumeExtensionCollisions) == 0x0002C8, "Member 'UAkRoomComponent::bIgnoreVolumeExtensionCollisions' has a wrong offset!");
static_assert(offsetof(UAkRoomComponent, bEnable) == 0x0002C9, "Member 'UAkRoomComponent::bEnable' has a wrong offset!");
static_assert(offsetof(UAkRoomComponent, bDynamic) == 0x0002CA, "Member 'UAkRoomComponent::bDynamic' has a wrong offset!");
static_assert(offsetof(UAkRoomComponent, Priority) == 0x0002CC, "Member 'UAkRoomComponent::Priority' has a wrong offset!");
static_assert(offsetof(UAkRoomComponent, WallOcclusion) == 0x0002D0, "Member 'UAkRoomComponent::WallOcclusion' has a wrong offset!");
static_assert(offsetof(UAkRoomComponent, AuxSendLevel) == 0x0002D4, "Member 'UAkRoomComponent::AuxSendLevel' has a wrong offset!");
static_assert(offsetof(UAkRoomComponent, AutoPost) == 0x0002D8, "Member 'UAkRoomComponent::AutoPost' has a wrong offset!");
static_assert(offsetof(UAkRoomComponent, bEnableReverbZone) == 0x0002D9, "Member 'UAkRoomComponent::bEnableReverbZone' has a wrong offset!");
static_assert(offsetof(UAkRoomComponent, ParentRoomActor) == 0x0002E0, "Member 'UAkRoomComponent::ParentRoomActor' has a wrong offset!");
static_assert(offsetof(UAkRoomComponent, ParentRoomName) == 0x0002E8, "Member 'UAkRoomComponent::ParentRoomName' has a wrong offset!");
static_assert(offsetof(UAkRoomComponent, TransitionRegionWidth) == 0x0002F8, "Member 'UAkRoomComponent::TransitionRegionWidth' has a wrong offset!");
static_assert(offsetof(UAkRoomComponent, GeometryComponent) == 0x000308, "Member 'UAkRoomComponent::GeometryComponent' has a wrong offset!");
static_assert(offsetof(UAkRoomComponent, ParentRoom) == 0x000368, "Member 'UAkRoomComponent::ParentRoom' has a wrong offset!");
...
public:
	...
	float                                         DefaultScalingFactor;                              // 0x03E8(0x0004)(Edit, ZeroConstructor, Config, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          AskedToUseNewAssetManagement;                      // 0x03EC(0x0001)(ZeroConstructor, Config, Deprecated, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bEnableMultiCoreRendering;                         // 0x03ED(0x0001)(ZeroConstructor, Config, Deprecated, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          MigratedEnableMultiCoreRendering;                  // 0x03EE(0x0001)(ZeroConstructor, Config, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          FixupRedirectorsDuringMigration;                   // 0x03EF(0x0001)(ZeroConstructor, Config, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(UAkSettings) == 0x000468, "Wrong size on UAkSettings");
...
static_assert(offsetof(UAkSettings, DefaultScalingFactor) == 0x0003E8, "Member 'UAkSettings::DefaultScalingFactor' has a wrong offset!");
static_assert(offsetof(UAkSettings, AskedToUseNewAssetManagement) == 0x0003EC, "Member 'UAkSettings::AskedToUseNewAssetManagement' has a wrong offset!");
static_assert(offsetof(UAkSettings, bEnableMultiCoreRendering) == 0x0003ED, "Member 'UAkSettings::bEnableMultiCoreRendering' has a wrong offset!");
static_assert(offsetof(UAkSettings, MigratedEnableMultiCoreRendering) == 0x0003EE, "Member 'UAkSettings::MigratedEnableMultiCoreRendering' has a wrong offset!");
static_assert(offsetof(UAkSettings, FixupRedirectorsDuringMigration) == 0x0003EF, "Member 'UAkSettings::FixupRedirectorsDuringMigration' has a wrong offset!");
...
public:
	...
	bool                                          VisualizeRoomsAndPortals;                          // 0x0087(0x0001)(Edit, ZeroConstructor, Config, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          VisualizeSources;                                  // 0x0088(0x0001)(Edit, ZeroConstructor, Config, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          VisualizeComposition;                              // 0x0089(0x0001)(Edit, ZeroConstructor, Config, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_8A[0x2];                                       // 0x008A(0x0002)(Fixing Size After Last Property [ Dumper-7 ])
	float                                         VisualizationMaxRadius;                            // 0x008C(0x0004)(Edit, ZeroConstructor, Config, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(offsetof(UAkSettingsPerUser, VisualizeRoomsAndPortals) == 0x000087, "Member 'UAkSettingsPerUser::VisualizeRoomsAndPortals' has a wrong offset!");
static_assert(offsetof(UAkSettingsPerUser, VisualizeSources) == 0x000088, "Member 'UAkSettingsPerUser::VisualizeSources' has a wrong offset!");
static_assert(offsetof(UAkSettingsPerUser, VisualizeComposition) == 0x000089, "Member 'UAkSettingsPerUser::VisualizeComposition' has a wrong offset!");
static_assert(offsetof(UAkSettingsPerUser, VisualizationMaxRadius) == 0x00008C, "Member 'UAkSettingsPerUser::VisualizationMaxRadius' has a wrong offset!");

// Class AkAudio.AkSlider
// 0x06B0 (0x0800 - 0x0150)
...
public:
	...
	struct FAkPropertyToControl                   ThePropertyToControl;                              // 0x0760(0x0010)(Edit, EditConst, NativeAccessSpecifierPublic)
	struct FAkWwiseItemToControl                  ItemToControl;                                     // 0x0770(0x0040)(Edit, Config, EditConst, NativeAccessSpecifierPublic)
	...
	TMulticastInlineDelegate<void(const struct FGuid& ItemDroppedID)> OnItemDropped;                                     // 0x07C0(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	TMulticastInlineDelegate<void(const class FString& PropertyDropped)> OnPropertyDropped;                                 // 0x07D0(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
...
static_assert(sizeof(UAkSlider) == 0x000800, "Wrong size on UAkSlider");
...
static_assert(offsetof(UAkSlider, Orientation) == 0x000730, "Member 'UAkSlider::Orientation' has a wrong offset!");
static_assert(offsetof(UAkSlider, SliderBarColor) == 0x000734, "Member 'UAkSlider::SliderBarColor' has a wrong offset!");
static_assert(offsetof(UAkSlider, SliderHandleColor) == 0x000744, "Member 'UAkSlider::SliderHandleColor' has a wrong offset!");
static_assert(offsetof(UAkSlider, IndentHandle) == 0x000754, "Member 'UAkSlider::IndentHandle' has a wrong offset!");
static_assert(offsetof(UAkSlider, Locked) == 0x000755, "Member 'UAkSlider::Locked' has a wrong offset!");
static_assert(offsetof(UAkSlider, StepSize) == 0x000758, "Member 'UAkSlider::StepSize' has a wrong offset!");
static_assert(offsetof(UAkSlider, IsFocusable) == 0x00075C, "Member 'UAkSlider::IsFocusable' has a wrong offset!");
static_assert(offsetof(UAkSlider, ThePropertyToControl) == 0x000760, "Member 'UAkSlider::ThePropertyToControl' has a wrong offset!");
static_assert(offsetof(UAkSlider, ItemToControl) == 0x000770, "Member 'UAkSlider::ItemToControl' has a wrong offset!");
static_assert(offsetof(UAkSlider, OnValueChanged) == 0x0007B0, "Member 'UAkSlider::OnValueChanged' has a wrong offset!");
static_assert(offsetof(UAkSlider, OnItemDropped) == 0x0007C0, "Member 'UAkSlider::OnItemDropped' has a wrong offset!");
static_assert(offsetof(UAkSlider, OnPropertyDropped) == 0x0007D0, "Member 'UAkSlider::OnPropertyDropped' has a wrong offset!");
...
{
public:
	class USoundSubmix*                           SubmixToRecord;                                    // 0x0518(0x0008)(Edit, BlueprintVisible, ZeroConstructor, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(UAkSubmixInputComponent) == 0x000540, "Wrong size on UAkSubmixInputComponent");
static_assert(offsetof(UAkSubmixInputComponent, SubmixToRecord) == 0x000518, "Member 'UAkSubmixInputComponent::SubmixToRecord' has a wrong offset!");
