...
// Class Landscape.BakedFoliageActor
// 0x00E0 (0x0378 - 0x0298)
class ABakedFoliageActor final : public AActor
{
public:
	uint8                                         Pad_298[0x8];                                      // 0x0298(0x0008)(Fixing Size After Last Property [ Dumper-7 ])
	struct FGuid                                  LandscapeGuid;                                     // 0x02A0(0x0010)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	int32                                         ComponentSectionBaseX;                             // 0x02B0(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	int32                                         ComponentSectionBaseY;                             // 0x02B4(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	int32                                         ComponentSizeQuads;                                // 0x02B8(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_2BC[0x4];                                      // 0x02BC(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	struct FBox                                   Bounds;                                            // 0x02C0(0x0038)(ZeroConstructor, IsPlainOldData, NoDestructor, NativeAccessSpecifierPublic)
	bool                                          bIsDistantTrees;                                   // 0x02F8(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_2F9[0x7];                                      // 0x02F9(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	struct FBakedFoliage                          BakedFoliage;                                      // 0x0300(0x0078)(NativeAccessSpecifierPublic)

public:
	static class UClass* StaticClass()
	{
		return StaticClassImpl<"BakedFoliageActor">();
	}
	static class ABakedFoliageActor* GetDefaultObj()
	{
		return GetDefaultObjImpl<ABakedFoliageActor>();
	}
};
static_assert(alignof(ABakedFoliageActor) == 0x000008, "Wrong alignment on ABakedFoliageActor");
static_assert(sizeof(ABakedFoliageActor) == 0x000378, "Wrong size on ABakedFoliageActor");
static_assert(offsetof(ABakedFoliageActor, LandscapeGuid) == 0x0002A0, "Member 'ABakedFoliageActor::LandscapeGuid' has a wrong offset!");
static_assert(offsetof(ABakedFoliageActor, ComponentSectionBaseX) == 0x0002B0, "Member 'ABakedFoliageActor::ComponentSectionBaseX' has a wrong offset!");
static_assert(offsetof(ABakedFoliageActor, ComponentSectionBaseY) == 0x0002B4, "Member 'ABakedFoliageActor::ComponentSectionBaseY' has a wrong offset!");
static_assert(offsetof(ABakedFoliageActor, ComponentSizeQuads) == 0x0002B8, "Member 'ABakedFoliageActor::ComponentSizeQuads' has a wrong offset!");
static_assert(offsetof(ABakedFoliageActor, Bounds) == 0x0002C0, "Member 'ABakedFoliageActor::Bounds' has a wrong offset!");
static_assert(offsetof(ABakedFoliageActor, bIsDistantTrees) == 0x0002F8, "Member 'ABakedFoliageActor::bIsDistantTrees' has a wrong offset!");
static_assert(offsetof(ABakedFoliageActor, BakedFoliage) == 0x000300, "Member 'ABakedFoliageActor::BakedFoliage' has a wrong offset!");
...
// Class Landscape.GeometryCollisionMap
// 0x0000 (0x0028 - 0x0028)
class UGeometryCollisionMap final : public UObject
{
public:
	static class UClass* StaticClass()
	{
		return StaticClassImpl<"GeometryCollisionMap">();
	}
	static class UGeometryCollisionMap* GetDefaultObj()
	{
		return GetDefaultObjImpl<UGeometryCollisionMap>();
	}
};
static_assert(alignof(UGeometryCollisionMap) == 0x000008, "Wrong alignment on UGeometryCollisionMap");
static_assert(sizeof(UGeometryCollisionMap) == 0x000028, "Wrong size on UGeometryCollisionMap");

// Class Landscape.GSCFoliageGeneratorConfig
// 0x0038 (0x0060 - 0x0028)
class UGSCFoliageGeneratorConfig final : public UObject
{
public:
	...
	TArray<struct FBiomInfo>                      Bioms;                                             // 0x0048(0x0010)(Edit, ZeroConstructor, NativeAccessSpecifierPublic)
	class UTileBitmapAdapter*                     BiomBitmapsAdapter;                                // 0x0058(0x0008)(Edit, ExportObject, ZeroConstructor, InstancedReference, NoDestructor, PersistentInstance, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)

public:
	static class UClass* StaticClass()
	{
		return StaticClassImpl<"GSCFoliageGeneratorConfig">();
	}
	static class UGSCFoliageGeneratorConfig* GetDefaultObj()
	{
		return GetDefaultObjImpl<UGSCFoliageGeneratorConfig>();
	}
};
static_assert(alignof(UGSCFoliageGeneratorConfig) == 0x000008, "Wrong alignment on UGSCFoliageGeneratorConfig");
static_assert(sizeof(UGSCFoliageGeneratorConfig) == 0x000060, "Wrong size on UGSCFoliageGeneratorConfig");
static_assert(offsetof(UGSCFoliageGeneratorConfig, WorldTopLeftCoords) == 0x000028, "Member 'UGSCFoliageGeneratorConfig::WorldTopLeftCoords' has a wrong offset!");
static_assert(offsetof(UGSCFoliageGeneratorConfig, WorldWidth) == 0x000040, "Member 'UGSCFoliageGeneratorConfig::WorldWidth' has a wrong offset!");
static_assert(offsetof(UGSCFoliageGeneratorConfig, WorldHeight) == 0x000044, "Member 'UGSCFoliageGeneratorConfig::WorldHeight' has a wrong offset!");
static_assert(offsetof(UGSCFoliageGeneratorConfig, Bioms) == 0x000048, "Member 'UGSCFoliageGeneratorConfig::Bioms' has a wrong offset!");
static_assert(offsetof(UGSCFoliageGeneratorConfig, BiomBitmapsAdapter) == 0x000058, "Member 'UGSCFoliageGeneratorConfig::BiomBitmapsAdapter' has a wrong offset!");

// Class Landscape.GSCFoliagePrefab
// 0x0010 (0x0038 - 0x0028)
class UGSCFoliagePrefab final : public UObject
{
public:
...
public:
	static class UClass* StaticClass()
	{
		return StaticClassImpl<"GSCFoliagePrefab">();
	}
	static class UGSCFoliagePrefab* GetDefaultObj()
	{
		return GetDefaultObjImpl<UGSCFoliagePrefab>();
	}
};
static_assert(alignof(UGSCFoliagePrefab) == 0x000008, "Wrong alignment on UGSCFoliagePrefab");
static_assert(sizeof(UGSCFoliagePrefab) == 0x000038, "Wrong size on UGSCFoliagePrefab");
static_assert(offsetof(UGSCFoliagePrefab, PrefabChildren) == 0x000028, "Member 'UGSCFoliagePrefab::PrefabChildren' has a wrong offset!");

// Class Landscape.GSCObjectPattern
// 0x0010 (0x0038 - 0x0028)
class UGSCObjectPattern final : public UObject
{
public:
...
public:
	static class UClass* StaticClass()
	{
		return StaticClassImpl<"GSCObjectPattern">();
	}
	static class UGSCObjectPattern* GetDefaultObj()
	{
		return GetDefaultObjImpl<UGSCObjectPattern>();
	}
};
static_assert(alignof(UGSCObjectPattern) == 0x000008, "Wrong alignment on UGSCObjectPattern");
static_assert(sizeof(UGSCObjectPattern) == 0x000038, "Wrong size on UGSCObjectPattern");
static_assert(offsetof(UGSCObjectPattern, Children) == 0x000028, "Member 'UGSCObjectPattern::Children' has a wrong offset!");

// Class Landscape.TileBitmapAdapter
// 0x00A0 (0x00C8 - 0x0028)
class UTileBitmapAdapter final : public UObject
{
public:
	int32                                         TileBitmapSize;                                    // 0x0028(0x0004)(Edit, ZeroConstructor, EditConst, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	int32                                         ActualTileBitmapSize;                              // 0x002C(0x0004)(Edit, ZeroConstructor, EditConst, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	...
	class UTexture2D*                             LandscapeBitmap;                                   // 0x00B8(0x0008)(Edit, ZeroConstructor, Transient, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
...
public:
	static class UClass* StaticClass()
	{
		return StaticClassImpl<"TileBitmapAdapter">();
	}
	static class UTileBitmapAdapter* GetDefaultObj()
	{
		return GetDefaultObjImpl<UTileBitmapAdapter>();
	}
};
static_assert(alignof(UTileBitmapAdapter) == 0x000008, "Wrong alignment on UTileBitmapAdapter");
static_assert(sizeof(UTileBitmapAdapter) == 0x0000C8, "Wrong size on UTileBitmapAdapter");
static_assert(offsetof(UTileBitmapAdapter, TileBitmapSize) == 0x000028, "Member 'UTileBitmapAdapter::TileBitmapSize' has a wrong offset!");
static_assert(offsetof(UTileBitmapAdapter, ActualTileBitmapSize) == 0x00002C, "Member 'UTileBitmapAdapter::ActualTileBitmapSize' has a wrong offset!");
static_assert(offsetof(UTileBitmapAdapter, bValid) == 0x000030, "Member 'UTileBitmapAdapter::bValid' has a wrong offset!");
static_assert(offsetof(UTileBitmapAdapter, TileBitmaps) == 0x000038, "Member 'UTileBitmapAdapter::TileBitmaps' has a wrong offset!");
static_assert(offsetof(UTileBitmapAdapter, TileBitmapsFolder) == 0x000098, "Member 'UTileBitmapAdapter::TileBitmapsFolder' has a wrong offset!");
static_assert(offsetof(UTileBitmapAdapter, BitmapNamePrefix) == 0x0000A8, "Member 'UTileBitmapAdapter::BitmapNamePrefix' has a wrong offset!");
static_assert(offsetof(UTileBitmapAdapter, LandscapeBitmap) == 0x0000B8, "Member 'UTileBitmapAdapter::LandscapeBitmap' has a wrong offset!");
static_assert(offsetof(UTileBitmapAdapter, bLoadTileBitmapsFromLandscapeBitmap) == 0x0000C0, "Member 'UTileBitmapAdapter::bLoadTileBitmapsFromLandscapeBitmap' has a wrong offset!");
static_assert(offsetof(UTileBitmapAdapter, bLoadTileBitmapsFromFolder) == 0x0000C1, "Member 'UTileBitmapAdapter::bLoadTileBitmapsFromFolder' has a wrong offset!");
static_assert(offsetof(UTileBitmapAdapter, bMergeTileBitmapsToLandscapeBitmap) == 0x0000C2, "Member 'UTileBitmapAdapter::bMergeTileBitmapsToLandscapeBitmap' has a wrong offset!");
static_assert(offsetof(UTileBitmapAdapter, bValidateTileBitmaps) == 0x0000C3, "Member 'UTileBitmapAdapter::bValidateTileBitmaps' has a wrong offset!");
...
public:
	...
	uint8                                         bAffectDynamicIndirectLighting : 1;                // 0x040C(0x0001)(BitIndex: 0x01, PropSize: 0x0001 (Edit, BlueprintVisible, BlueprintReadOnly, NoDestructor, AdvancedDisplay, HasGetValueTypeHash, NativeAccessSpecifierPublic))
...
public:
	...
	void EditorApplySplineGSC(class USplineComponent* InSplineComponent, float StartWidth, float EndWidth, float StartSideFalloff, float EndSideFalloff, float HeightOffset, int32 NumSubdivisions, bool bRaiseHeights, bool bLowerHeights, class ULandscapeLayerInfoObject* PaintLayer, class FName EditLayerName);
...
static_assert(sizeof(ALandscapeProxy) == 0x0005F8, "Wrong size on ALandscapeProxy");
...
{
public:
	class UGSCFoliageGeneratorConfig*             FoliageGeneratorConfig;                            // 0x05F8(0x0008)(Edit, ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(ALandscape) == 0x000628, "Wrong size on ALandscape");
static_assert(offsetof(ALandscape, FoliageGeneratorConfig) == 0x0005F8, "Member 'ALandscape::FoliageGeneratorConfig' has a wrong offset!");
...
public:
	...
	class UMaterialInterface*                     OverrideMaterial;                                  // 0x0578(0x0008)(Edit, BlueprintVisible, ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class UMaterialInterface*                     OverrideHoleMaterial;                              // 0x0580(0x0008)(Edit, BlueprintVisible, ZeroConstructor, NoDestructor, AdvancedDisplay, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	TArray<class UMaterialInstanceConstant*>      MaterialInstances;                                 // 0x0588(0x0010)(ZeroConstructor, TextExportTransient, UObjectWrapper, NativeAccessSpecifierPublic)
	TArray<class UMaterialInstanceDynamic*>       MaterialInstancesDynamic;                          // 0x0598(0x0010)(ZeroConstructor, Transient, TextExportTransient, UObjectWrapper, NativeAccessSpecifierPublic)
	TArray<int8>                                  LODIndexToMaterialIndex;                           // 0x05A8(0x0010)(ZeroConstructor, TextExportTransient, NativeAccessSpecifierPublic)
	class UTexture2D*                             XYOffsetmapTexture;                                // 0x05B8(0x0008)(ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	...
	bool                                          bNaniteActive;                                     // 0x0664(0x0001)(ZeroConstructor, Transient, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	...
	TArray<struct FGuid>                          IrrelevantLights;                                  // 0x06C0(0x0010)(ZeroConstructor, Deprecated, NativeAccessSpecifierPublic)
...
static_assert(offsetof(ULandscapeComponent, LODIndexToMaterialIndex) == 0x0005A8, "Member 'ULandscapeComponent::LODIndexToMaterialIndex' has a wrong offset!");
static_assert(offsetof(ULandscapeComponent, XYOffsetmapTexture) == 0x0005B8, "Member 'ULandscapeComponent::XYOffsetmapTexture' has a wrong offset!");
static_assert(offsetof(ULandscapeComponent, WeightmapScaleBias) == 0x0005C0, "Member 'ULandscapeComponent::WeightmapScaleBias' has a wrong offset!");
...
static_assert(offsetof(ULandscapeComponent, CachedLocalBox) == 0x000610, "Member 'ULandscapeComponent::CachedLocalBox' has a wrong offset!");
static_assert(offsetof(ULandscapeComponent, CollisionComponent) == 0x000648, "Member 'ULandscapeComponent::CollisionComponent' has a wrong offset!");
static_assert(offsetof(ULandscapeComponent, bNaniteActive) == 0x000664, "Member 'ULandscapeComponent::bNaniteActive' has a wrong offset!");
...
static_assert(offsetof(ULandscapeComponent, IrrelevantLights) == 0x0006C0, "Member 'ULandscapeComponent::IrrelevantLights' has a wrong offset!");
...
{
public:
	TArray<class ULandscapeLayerInfoObject*>      ComponentLayerInfos;                               // 0x0560(0x0010)(ZeroConstructor, UObjectWrapper, NativeAccessSpecifierPublic)
	...
	struct FBox                                   CachedLocalBox;                                    // 0x05A8(0x0038)(ZeroConstructor, IsPlainOldData, NoDestructor, NativeAccessSpecifierPublic)
	TLazyObjectPtr<class ULandscapeComponent>     RenderComponent;                                   // 0x05E0(0x001C)(ExportObject, InstancedReference, IsPlainOldData, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	...
	uint8                                         Pad_620[0x40];                                     // 0x0620(0x0040)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(offsetof(ULandscapeHeightfieldCollisionComponent, RenderComponent) == 0x0005E0, "Member 'ULandscapeHeightfieldCollisionComponent::RenderComponent' has a wrong offset!");
...
{
public:
	TArray<struct FLandscapeMaterialTextureStreamingInfo> TextureStreamingInfo;                              // 0x0228(0x0010)(ZeroConstructor, NativeAccessSpecifierPublic)
	uint8                                         bIsLayerThumbnail : 1;                             // 0x0238(0x0001)(BitIndex: 0x00, PropSize: 0x0001 (NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         bDisableTessellation : 1;                          // 0x0238(0x0001)(BitIndex: 0x01, PropSize: 0x0001 (Deprecated, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         bMobile : 1;                                       // 0x0238(0x0001)(BitIndex: 0x02, PropSize: 0x0001 (NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         bEditorToolUsage : 1;                              // 0x0238(0x0001)(BitIndex: 0x03, PropSize: 0x0001 (NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
...
static_assert(sizeof(ULandscapeMaterialInstanceConstant) == 0x000240, "Wrong size on ULandscapeMaterialInstanceConstant");
static_assert(offsetof(ULandscapeMaterialInstanceConstant, TextureStreamingInfo) == 0x000228, "Member 'ULandscapeMaterialInstanceConstant::TextureStreamingInfo' has a wrong offset!");
...
{
public:
	TArray<class ULandscapeSplineControlPoint*>   ControlPoints;                                     // 0x0560(0x0010)(ZeroConstructor, Protected, TextExportTransient, UObjectWrapper, NativeAccessSpecifierProtected)
	TArray<class ULandscapeSplineSegment*>        Segments;                                          // 0x0570(0x0010)(ZeroConstructor, Protected, TextExportTransient, UObjectWrapper, NativeAccessSpecifierProtected)
	TArray<class UMeshComponent*>                 CookedForeignMeshComponents;                       // 0x0580(0x0010)(ExportObject, ZeroConstructor, ContainsInstancedReference, Protected, TextExportTransient, UObjectWrapper, NativeAccessSpecifierProtected)
...
public:
	...
	uint8                                         Pad_614[0x4];                                      // 0x0614(0x0004)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(ALandscapeStreamingProxy) == 0x000618, "Wrong size on ALandscapeStreamingProxy");
...
static_assert(sizeof(ULandscapeSubsystem) == 0x0000B0, "Wrong size on ULandscapeSubsystem");
