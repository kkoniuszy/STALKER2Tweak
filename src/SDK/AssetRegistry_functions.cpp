...
class FString UAssetRegistryHelpers::GetShortName(const struct FAssetData& InAssetData)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = StaticClass()->GetFunction("AssetRegistryHelpers", "GetShortName");

	Params::AssetRegistryHelpers_GetShortName Parms{};
...
void UAssetRegistryHelpers::SortAssetData(const TArray<struct FAssetData>& InAssetData, TArray<struct FAssetData>* OutAssetData)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = StaticClass()->GetFunction("AssetRegistryHelpers", "SortAssetData");

	Params::AssetRegistryHelpers_SortAssetData Parms{};
