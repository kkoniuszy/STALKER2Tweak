...
public:
	...
	struct FGuid                                  GSCQuestGuid;                                      // 0x0040(0x0010)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
};
...
static_assert(offsetof(FLevelSequenceBindingReference, GSCQuestGuid) == 0x000040, "Member 'FLevelSequenceBindingReference::GSCQuestGuid' has a wrong offset!");
