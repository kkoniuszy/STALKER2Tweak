...
static_assert(sizeof(UModioPopupBase) == 0x000278, "Wrong size on UModioPopupBase");
...
{
public:
	TArray<class UModioPopupBase*>                PopupStack;                                        // 0x0278(0x0010)(ExportObject, ZeroConstructor, Transient, ContainsInstancedReference, NativeAccessSpecifierPrivate)
	TArray<class UModioPopupBase*>                PopupCache;                                        // 0x0288(0x0010)(ExportObject, ZeroConstructor, Transient, ContainsInstancedReference, NativeAccessSpecifierPrivate)
...
static_assert(sizeof(UModioPopupContainer) == 0x000298, "Wrong size on UModioPopupContainer");
static_assert(offsetof(UModioPopupContainer, PopupStack) == 0x000278, "Member 'UModioPopupContainer::PopupStack' has a wrong offset!");
static_assert(offsetof(UModioPopupContainer, PopupCache) == 0x000288, "Member 'UModioPopupContainer::PopupCache' has a wrong offset!");
