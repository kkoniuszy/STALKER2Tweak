...
public:
	...
	struct FTextBlockStyle                        TextStyle;                                         // 0x0010(0x03A0)(Edit, NativeAccessSpecifierPublic)
};
static_assert(alignof(FRichTextStyleRow) == 0x000010, "Wrong alignment on FRichTextStyleRow");
static_assert(sizeof(FRichTextStyleRow) == 0x0003B0, "Wrong size on FRichTextStyleRow");
static_assert(offsetof(FRichTextStyleRow, TextStyle) == 0x000010, "Member 'FRichTextStyleRow::TextStyle' has a wrong offset!");

// ScriptStruct UMG.TextureRow
// 0x0008 (0x0010 - 0x0008)
struct FTextureRow final : public FTableRowBase
{
public:
...
static_assert(alignof(FTextureRow) == 0x000008, "Wrong alignment on FTextureRow");
static_assert(sizeof(FTextureRow) == 0x000010, "Wrong size on FTextureRow");
static_assert(offsetof(FTextureRow, Texture) == 0x000008, "Member 'FTextureRow::Texture' has a wrong offset!");
...
public:
	uint8                                         Pad_8[0x8];                                        // 0x0008(0x0008)(Fixing Size After Last Property [ Dumper-7 ])
	struct FSlateBrush                            Brush;                                             // 0x0010(0x00F0)(Edit, NativeAccessSpecifierPublic)
};
static_assert(alignof(FRichImageRow) == 0x000010, "Wrong alignment on FRichImageRow");
static_assert(sizeof(FRichImageRow) == 0x000100, "Wrong size on FRichImageRow");
