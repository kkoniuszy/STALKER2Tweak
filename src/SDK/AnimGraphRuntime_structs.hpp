...
struct FAnimNode_TwoBoneSimpleIK_GSC final : public FAnimNode_SkeletalControlBase
{
public:
	...
	uint8                                         bAllowTwist : 1;                                   // 0x0130(0x0001)(BitIndex: 0x01, PropSize: 0x0001 (Edit, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         Pad_131[0x7];                                      // 0x0131(0x0007)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(FAnimNode_TwoBoneSimpleIK_GSC) == 0x000008, "Wrong alignment on FAnimNode_TwoBoneSimpleIK_GSC");
static_assert(sizeof(FAnimNode_TwoBoneSimpleIK_GSC) == 0x000138, "Wrong size on FAnimNode_TwoBoneSimpleIK_GSC");
static_assert(offsetof(FAnimNode_TwoBoneSimpleIK_GSC, IKBone) == 0x0000C8, "Member 'FAnimNode_TwoBoneSimpleIK_GSC::IKBone' has a wrong offset!");
static_assert(offsetof(FAnimNode_TwoBoneSimpleIK_GSC, StartStretchRatio) == 0x0000D8, "Member 'FAnimNode_TwoBoneSimpleIK_GSC::StartStretchRatio' has a wrong offset!");
static_assert(offsetof(FAnimNode_TwoBoneSimpleIK_GSC, MaxStretchScale) == 0x0000DC, "Member 'FAnimNode_TwoBoneSimpleIK_GSC::MaxStretchScale' has a wrong offset!");
static_assert(offsetof(FAnimNode_TwoBoneSimpleIK_GSC, IKBoneTarget) == 0x0000E0, "Member 'FAnimNode_TwoBoneSimpleIK_GSC::IKBoneTarget' has a wrong offset!");
static_assert(offsetof(FAnimNode_TwoBoneSimpleIK_GSC, JointBoneTarget) == 0x0000F0, "Member 'FAnimNode_TwoBoneSimpleIK_GSC::JointBoneTarget' has a wrong offset!");
static_assert(offsetof(FAnimNode_TwoBoneSimpleIK_GSC, bSaveOriginalRotation) == 0x000100, "Member 'FAnimNode_TwoBoneSimpleIK_GSC::bSaveOriginalRotation' has a wrong offset!");
static_assert(offsetof(FAnimNode_TwoBoneSimpleIK_GSC, TwistAxis) == 0x000110, "Member 'FAnimNode_TwoBoneSimpleIK_GSC::TwistAxis' has a wrong offset!");
...
struct FAnimNode_BlendListByPointer_GSC final : public FAnimNode_BlendListBase
{
};
static_assert(alignof(FAnimNode_BlendListByPointer_GSC) == 0x000008, "Wrong alignment on FAnimNode_BlendListByPointer_GSC");
static_assert(sizeof(FAnimNode_BlendListByPointer_GSC) == 0x000048, "Wrong size on FAnimNode_BlendListByPointer_GSC");
...
struct FAnimNode_AdvancedIK_GSC final : public FAnimNode_SkeletalControlBase
{
public:
	...
	uint8                                         bAllowStretching : 1;                              // 0x0118(0x0001)(BitIndex: 0x00, PropSize: 0x0001 (Edit, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         bAllowTwist : 1;                                   // 0x0118(0x0001)(BitIndex: 0x01, PropSize: 0x0001 (Edit, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         Pad_119[0x7];                                      // 0x0119(0x0007)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(FAnimNode_AdvancedIK_GSC) == 0x000008, "Wrong alignment on FAnimNode_AdvancedIK_GSC");
static_assert(sizeof(FAnimNode_AdvancedIK_GSC) == 0x000120, "Wrong size on FAnimNode_AdvancedIK_GSC");
static_assert(offsetof(FAnimNode_AdvancedIK_GSC, IKParam) == 0x0000C8, "Member 'FAnimNode_AdvancedIK_GSC::IKParam' has a wrong offset!");
static_assert(offsetof(FAnimNode_AdvancedIK_GSC, StartStretchRatio) == 0x0000F0, "Member 'FAnimNode_AdvancedIK_GSC::StartStretchRatio' has a wrong offset!");
static_assert(offsetof(FAnimNode_AdvancedIK_GSC, MaxStretchScale) == 0x0000F4, "Member 'FAnimNode_AdvancedIK_GSC::MaxStretchScale' has a wrong offset!");
static_assert(offsetof(FAnimNode_AdvancedIK_GSC, TwistAxis) == 0x0000F8, "Member 'FAnimNode_AdvancedIK_GSC::TwistAxis' has a wrong offset!");
...
// 0x0070 (0x0138 - 0x00C8)
struct FAnimNode_CameraCopyBone_GSC final : public FAnimNode_SkeletalControlBase
{
public:
...
static_assert(alignof(FAnimNode_CameraCopyBone_GSC) == 0x000008, "Wrong alignment on FAnimNode_CameraCopyBone_GSC");
static_assert(sizeof(FAnimNode_CameraCopyBone_GSC) == 0x000138, "Wrong size on FAnimNode_CameraCopyBone_GSC");
static_assert(offsetof(FAnimNode_CameraCopyBone_GSC, SourceBone) == 0x0000C8, "Member 'FAnimNode_CameraCopyBone_GSC::SourceBone' has a wrong offset!");
static_assert(offsetof(FAnimNode_CameraCopyBone_GSC, TargetBone) == 0x0000D8, "Member 'FAnimNode_CameraCopyBone_GSC::TargetBone' has a wrong offset!");
static_assert(offsetof(FAnimNode_CameraCopyBone_GSC, SocketRotation) == 0x0000E8, "Member 'FAnimNode_CameraCopyBone_GSC::SocketRotation' has a wrong offset!");
static_assert(offsetof(FAnimNode_CameraCopyBone_GSC, BoneShift) == 0x000100, "Member 'FAnimNode_CameraCopyBone_GSC::BoneShift' has a wrong offset!");
static_assert(offsetof(FAnimNode_CameraCopyBone_GSC, BoneRotate) == 0x000118, "Member 'FAnimNode_CameraCopyBone_GSC::BoneRotate' has a wrong offset!");
static_assert(offsetof(FAnimNode_CameraCopyBone_GSC, bCopyTranslation) == 0x000130, "Member 'FAnimNode_CameraCopyBone_GSC::bCopyTranslation' has a wrong offset!");
static_assert(offsetof(FAnimNode_CameraCopyBone_GSC, bCopyRotation) == 0x000131, "Member 'FAnimNode_CameraCopyBone_GSC::bCopyRotation' has a wrong offset!");
static_assert(offsetof(FAnimNode_CameraCopyBone_GSC, bCopyScale) == 0x000132, "Member 'FAnimNode_CameraCopyBone_GSC::bCopyScale' has a wrong offset!");
static_assert(offsetof(FAnimNode_CameraCopyBone_GSC, ControlSpace) == 0x000133, "Member 'FAnimNode_CameraCopyBone_GSC::ControlSpace' has a wrong offset!");

// ScriptStruct AnimGraphRuntime.AnimNode_CopyAnotherSkeletonBone_GSC
// 0x0028 (0x00F0 - 0x00C8)
struct FAnimNode_CopyAnotherSkeletonBone_GSC final : public FAnimNode_SkeletalControlBase
{
public:
	...
	class USkeletalMeshComponent*                 AnotherSkeletalMeshComponent;                      // 0x00E8(0x0008)(Edit, ExportObject, ZeroConstructor, InstancedReference, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
static_assert(alignof(FAnimNode_CopyAnotherSkeletonBone_GSC) == 0x000008, "Wrong alignment on FAnimNode_CopyAnotherSkeletonBone_GSC");
static_assert(sizeof(FAnimNode_CopyAnotherSkeletonBone_GSC) == 0x0000F0, "Wrong size on FAnimNode_CopyAnotherSkeletonBone_GSC");
static_assert(offsetof(FAnimNode_CopyAnotherSkeletonBone_GSC, SourceBone) == 0x0000C8, "Member 'FAnimNode_CopyAnotherSkeletonBone_GSC::SourceBone' has a wrong offset!");
static_assert(offsetof(FAnimNode_CopyAnotherSkeletonBone_GSC, TargetBone) == 0x0000D0, "Member 'FAnimNode_CopyAnotherSkeletonBone_GSC::TargetBone' has a wrong offset!");
static_assert(offsetof(FAnimNode_CopyAnotherSkeletonBone_GSC, bCopyTranslation) == 0x0000E0, "Member 'FAnimNode_CopyAnotherSkeletonBone_GSC::bCopyTranslation' has a wrong offset!");
static_assert(offsetof(FAnimNode_CopyAnotherSkeletonBone_GSC, bCopyRotation) == 0x0000E1, "Member 'FAnimNode_CopyAnotherSkeletonBone_GSC::bCopyRotation' has a wrong offset!");
static_assert(offsetof(FAnimNode_CopyAnotherSkeletonBone_GSC, bCopyScale) == 0x0000E2, "Member 'FAnimNode_CopyAnotherSkeletonBone_GSC::bCopyScale' has a wrong offset!");
static_assert(offsetof(FAnimNode_CopyAnotherSkeletonBone_GSC, ControlSpace) == 0x0000E3, "Member 'FAnimNode_CopyAnotherSkeletonBone_GSC::ControlSpace' has a wrong offset!");
static_assert(offsetof(FAnimNode_CopyAnotherSkeletonBone_GSC, AnotherSkeletalMeshComponent) == 0x0000E8, "Member 'FAnimNode_CopyAnotherSkeletonBone_GSC::AnotherSkeletalMeshComponent' has a wrong offset!");

// ScriptStruct AnimGraphRuntime.AnimNode_DisableRootMotionGSC
// 0x0018 (0x0028 - 0x0010)
struct FAnimNode_DisableRootMotionGSC final : public FAnimNode_Base
{
public:
...
static_assert(alignof(FAnimNode_DisableRootMotionGSC) == 0x000008, "Wrong alignment on FAnimNode_DisableRootMotionGSC");
static_assert(sizeof(FAnimNode_DisableRootMotionGSC) == 0x000028, "Wrong size on FAnimNode_DisableRootMotionGSC");
static_assert(offsetof(FAnimNode_DisableRootMotionGSC, BasePose) == 0x000010, "Member 'FAnimNode_DisableRootMotionGSC::BasePose' has a wrong offset!");
static_assert(offsetof(FAnimNode_DisableRootMotionGSC, Alpha) == 0x000020, "Member 'FAnimNode_DisableRootMotionGSC::Alpha' has a wrong offset!");
...
struct FAnimNode_SmoothCopyBone_GSC final : public FAnimNode_SkeletalControlBase
{
public:
	struct FBoneReference                         SourceBone;                                        // 0x00C8(0x0010)(Edit, NoDestructor, NativeAccessSpecifierPublic)
	struct FBoneReference                         TargetBone;                                        // 0x00D8(0x0010)(Edit, NoDestructor, NativeAccessSpecifierPublic)
	...
	class USkeletalMeshComponent*                 WeaponSkeletalMeshComponent;                       // 0x0130(0x0008)(Edit, ExportObject, ZeroConstructor, InstancedReference, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(alignof(FAnimNode_SmoothCopyBone_GSC) == 0x000008, "Wrong alignment on FAnimNode_SmoothCopyBone_GSC");
static_assert(sizeof(FAnimNode_SmoothCopyBone_GSC) == 0x000160, "Wrong size on FAnimNode_SmoothCopyBone_GSC");
static_assert(offsetof(FAnimNode_SmoothCopyBone_GSC, SourceBone) == 0x0000C8, "Member 'FAnimNode_SmoothCopyBone_GSC::SourceBone' has a wrong offset!");
static_assert(offsetof(FAnimNode_SmoothCopyBone_GSC, TargetBone) == 0x0000D8, "Member 'FAnimNode_SmoothCopyBone_GSC::TargetBone' has a wrong offset!");
static_assert(offsetof(FAnimNode_SmoothCopyBone_GSC, WeaponTotalRotation) == 0x0000E8, "Member 'FAnimNode_SmoothCopyBone_GSC::WeaponTotalRotation' has a wrong offset!");
static_assert(offsetof(FAnimNode_SmoothCopyBone_GSC, WeaponTotalShift) == 0x000100, "Member 'FAnimNode_SmoothCopyBone_GSC::WeaponTotalShift' has a wrong offset!");
static_assert(offsetof(FAnimNode_SmoothCopyBone_GSC, WeaponSocketShift) == 0x000118, "Member 'FAnimNode_SmoothCopyBone_GSC::WeaponSocketShift' has a wrong offset!");
static_assert(offsetof(FAnimNode_SmoothCopyBone_GSC, WeaponSkeletalMeshComponent) == 0x000130, "Member 'FAnimNode_SmoothCopyBone_GSC::WeaponSkeletalMeshComponent' has a wrong offset!");
static_assert(offsetof(FAnimNode_SmoothCopyBone_GSC, DirectionWeaponSocketName) == 0x000138, "Member 'FAnimNode_SmoothCopyBone_GSC::DirectionWeaponSocketName' has a wrong offset!");
static_assert(offsetof(FAnimNode_SmoothCopyBone_GSC, ExtraRotator) == 0x000140, "Member 'FAnimNode_SmoothCopyBone_GSC::ExtraRotator' has a wrong offset!");
static_assert(offsetof(FAnimNode_SmoothCopyBone_GSC, ControlSpace) == 0x000158, "Member 'FAnimNode_SmoothCopyBone_GSC::ControlSpace' has a wrong offset!");

// ScriptStruct AnimGraphRuntime.AnimNode_TwoBoneIK_GSC
// 0x00B0 (0x0178 - 0x00C8)
struct FAnimNode_TwoBoneIK_GSC final : public FAnimNode_SkeletalControlBase
{
public:
	struct FBoneReference                         IKBone;                                            // 0x00C8(0x0010)(Edit, NoDestructor, NativeAccessSpecifierPublic)
	float                                         StartStretchRatio;                                 // 0x00D8(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         MaxStretchScale;                                   // 0x00DC(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class USkeletalMeshComponent*                 WeaponSkeletalMeshComponent;                       // 0x00E0(0x0008)(Edit, ExportObject, ZeroConstructor, InstancedReference, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	...
	struct FVector                                JointBoneOffset;                                   // 0x0100(0x0018)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FBoneReference                         WeaponBone;                                        // 0x0118(0x0010)(Edit, NoDestructor, NativeAccessSpecifierPublic)
	struct FRotator                               ExtraRotator;                                      // 0x0128(0x0018)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, NativeAccessSpecifierPublic)
	bool                                          bUseSocketRotation;                                // 0x0140(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_141[0xF];                                      // 0x0141(0x000F)(Fixing Size After Last Property [ Dumper-7 ])
	struct FAxis                                  TwistAxis;                                         // 0x0150(0x0020)(Edit, NoDestructor, NativeAccessSpecifierPublic)
	uint8                                         bAllowStretching : 1;                              // 0x0170(0x0001)(BitIndex: 0x00, PropSize: 0x0001 (Edit, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         bAllowTwist : 1;                                   // 0x0170(0x0001)(BitIndex: 0x01, PropSize: 0x0001 (Edit, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         Pad_171[0x7];                                      // 0x0171(0x0007)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(FAnimNode_TwoBoneIK_GSC) == 0x000008, "Wrong alignment on FAnimNode_TwoBoneIK_GSC");
static_assert(sizeof(FAnimNode_TwoBoneIK_GSC) == 0x000178, "Wrong size on FAnimNode_TwoBoneIK_GSC");
static_assert(offsetof(FAnimNode_TwoBoneIK_GSC, IKBone) == 0x0000C8, "Member 'FAnimNode_TwoBoneIK_GSC::IKBone' has a wrong offset!");
static_assert(offsetof(FAnimNode_TwoBoneIK_GSC, StartStretchRatio) == 0x0000D8, "Member 'FAnimNode_TwoBoneIK_GSC::StartStretchRatio' has a wrong offset!");
static_assert(offsetof(FAnimNode_TwoBoneIK_GSC, MaxStretchScale) == 0x0000DC, "Member 'FAnimNode_TwoBoneIK_GSC::MaxStretchScale' has a wrong offset!");
static_assert(offsetof(FAnimNode_TwoBoneIK_GSC, WeaponSkeletalMeshComponent) == 0x0000E0, "Member 'FAnimNode_TwoBoneIK_GSC::WeaponSkeletalMeshComponent' has a wrong offset!");
static_assert(offsetof(FAnimNode_TwoBoneIK_GSC, EffectorWeaponSocketName) == 0x0000E8, "Member 'FAnimNode_TwoBoneIK_GSC::EffectorWeaponSocketName' has a wrong offset!");
static_assert(offsetof(FAnimNode_TwoBoneIK_GSC, JointBone) == 0x0000F0, "Member 'FAnimNode_TwoBoneIK_GSC::JointBone' has a wrong offset!");
static_assert(offsetof(FAnimNode_TwoBoneIK_GSC, JointBoneOffset) == 0x000100, "Member 'FAnimNode_TwoBoneIK_GSC::JointBoneOffset' has a wrong offset!");
static_assert(offsetof(FAnimNode_TwoBoneIK_GSC, WeaponBone) == 0x000118, "Member 'FAnimNode_TwoBoneIK_GSC::WeaponBone' has a wrong offset!");
static_assert(offsetof(FAnimNode_TwoBoneIK_GSC, ExtraRotator) == 0x000128, "Member 'FAnimNode_TwoBoneIK_GSC::ExtraRotator' has a wrong offset!");
static_assert(offsetof(FAnimNode_TwoBoneIK_GSC, bUseSocketRotation) == 0x000140, "Member 'FAnimNode_TwoBoneIK_GSC::bUseSocketRotation' has a wrong offset!");
static_assert(offsetof(FAnimNode_TwoBoneIK_GSC, TwistAxis) == 0x000150, "Member 'FAnimNode_TwoBoneIK_GSC::TwistAxis' has a wrong offset!");

// ScriptStruct AnimGraphRuntime.AnimNode_TwoBoneShiftIK_GSC
// 0x0078 (0x0140 - 0x00C8)
struct FAnimNode_TwoBoneShiftIK_GSC final : public FAnimNode_SkeletalControlBase
{
public:
	struct FBoneReference                         IKBone;                                            // 0x00C8(0x0010)(Edit, NoDestructor, NativeAccessSpecifierPublic)
	float                                         StartStretchRatio;                                 // 0x00D8(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	...
	uint8                                         bAllowStretching : 1;                              // 0x0138(0x0001)(BitIndex: 0x00, PropSize: 0x0001 (Edit, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         bAllowTwist : 1;                                   // 0x0138(0x0001)(BitIndex: 0x01, PropSize: 0x0001 (Edit, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         Pad_139[0x7];                                      // 0x0139(0x0007)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(FAnimNode_TwoBoneShiftIK_GSC) == 0x000008, "Wrong alignment on FAnimNode_TwoBoneShiftIK_GSC");
static_assert(sizeof(FAnimNode_TwoBoneShiftIK_GSC) == 0x000140, "Wrong size on FAnimNode_TwoBoneShiftIK_GSC");
static_assert(offsetof(FAnimNode_TwoBoneShiftIK_GSC, IKBone) == 0x0000C8, "Member 'FAnimNode_TwoBoneShiftIK_GSC::IKBone' has a wrong offset!");
static_assert(offsetof(FAnimNode_TwoBoneShiftIK_GSC, StartStretchRatio) == 0x0000D8, "Member 'FAnimNode_TwoBoneShiftIK_GSC::StartStretchRatio' has a wrong offset!");
static_assert(offsetof(FAnimNode_TwoBoneShiftIK_GSC, MaxStretchScale) == 0x0000DC, "Member 'FAnimNode_TwoBoneShiftIK_GSC::MaxStretchScale' has a wrong offset!");
static_assert(offsetof(FAnimNode_TwoBoneShiftIK_GSC, EffectorOffset) == 0x0000E0, "Member 'FAnimNode_TwoBoneShiftIK_GSC::EffectorOffset' has a wrong offset!");
static_assert(offsetof(FAnimNode_TwoBoneShiftIK_GSC, JointOffset) == 0x0000F8, "Member 'FAnimNode_TwoBoneShiftIK_GSC::JointOffset' has a wrong offset!");
static_assert(offsetof(FAnimNode_TwoBoneShiftIK_GSC, TwistAxis) == 0x000118, "Member 'FAnimNode_TwoBoneShiftIK_GSC::TwistAxis' has a wrong offset!");
...
public:
	...
	class UCurveFloat*                            InterpSpeedForDifferentAngles;                     // 0x0190(0x0008)(Edit, BlueprintVisible, ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(offsetof(FAnimNode_AimOffsetLookAt, InterpSpeedForDifferentAngles) == 0x000190, "Member 'FAnimNode_AimOffsetLookAt::InterpSpeedForDifferentAngles' has a wrong offset!");
...
// ScriptStruct AnimGraphRuntime.AnimNode_CurveBlend_GSC
// 0x00D8 (0x00E8 - 0x0010)
struct FAnimNode_CurveBlend_GSC final : public FAnimNode_Base
{
public:
	...
	TArray<class FName>                           CurveArray;                                        // 0x0040(0x0010)(Edit, BlueprintVisible, ZeroConstructor, NativeAccessSpecifierPublic)
...
static_assert(alignof(FAnimNode_CurveBlend_GSC) == 0x000008, "Wrong alignment on FAnimNode_CurveBlend_GSC");
static_assert(sizeof(FAnimNode_CurveBlend_GSC) == 0x0000E8, "Wrong size on FAnimNode_CurveBlend_GSC");
static_assert(offsetof(FAnimNode_CurveBlend_GSC, SourcePose) == 0x000010, "Member 'FAnimNode_CurveBlend_GSC::SourcePose' has a wrong offset!");
static_assert(offsetof(FAnimNode_CurveBlend_GSC, A) == 0x000020, "Member 'FAnimNode_CurveBlend_GSC::A' has a wrong offset!");
static_assert(offsetof(FAnimNode_CurveBlend_GSC, B) == 0x000030, "Member 'FAnimNode_CurveBlend_GSC::B' has a wrong offset!");
static_assert(offsetof(FAnimNode_CurveBlend_GSC, CurveArray) == 0x000040, "Member 'FAnimNode_CurveBlend_GSC::CurveArray' has a wrong offset!");
static_assert(offsetof(FAnimNode_CurveBlend_GSC, AlphaInputType) == 0x000050, "Member 'FAnimNode_CurveBlend_GSC::AlphaInputType' has a wrong offset!");
static_assert(offsetof(FAnimNode_CurveBlend_GSC, Alpha) == 0x000054, "Member 'FAnimNode_CurveBlend_GSC::Alpha' has a wrong offset!");
static_assert(offsetof(FAnimNode_CurveBlend_GSC, AlphaScaleBias) == 0x000058, "Member 'FAnimNode_CurveBlend_GSC::AlphaScaleBias' has a wrong offset!");
static_assert(offsetof(FAnimNode_CurveBlend_GSC, AlphaBoolBlend) == 0x000060, "Member 'FAnimNode_CurveBlend_GSC::AlphaBoolBlend' has a wrong offset!");
static_assert(offsetof(FAnimNode_CurveBlend_GSC, AlphaCurveName) == 0x0000A8, "Member 'FAnimNode_CurveBlend_GSC::AlphaCurveName' has a wrong offset!");
static_assert(offsetof(FAnimNode_CurveBlend_GSC, AlphaScaleBiasClamp) == 0x0000B0, "Member 'FAnimNode_CurveBlend_GSC::AlphaScaleBiasClamp' has a wrong offset!");
...
static_assert(offsetof(FAnimNode_SequenceEvaluator_Standalone, bNormilizedExplicitTime) == 0x000064, "Member 'FAnimNode_SequenceEvaluator_Standalone::bNormilizedExplicitTime' has a wrong offset!");
...
static_assert(offsetof(FAnimLegIKDefinition, bEnabled) == 0x00002C, "Member 'FAnimLegIKDefinition::bEnabled' has a wrong offset!");
static_assert(offsetof(FAnimLegIKDefinition, Alpha) == 0x000030, "Member 'FAnimLegIKDefinition::Alpha' has a wrong offset!");
...
static_assert(sizeof(FAnimNode_SplineIK) == 0x0002A0, "Wrong size on FAnimNode_SplineIK");
