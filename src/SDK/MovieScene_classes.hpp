...
// 0x0000 (0x0028 - 0x0028)
class IGSCMovieSceneActor final : public IInterface
{
public:
	static class UClass* StaticClass()
	{
		return StaticClassImpl<"GSCMovieSceneActor">();
	}
	static class IGSCMovieSceneActor* GetDefaultObj()
	{
		return GetDefaultObjImpl<IGSCMovieSceneActor>();
	}
};
static_assert(alignof(IGSCMovieSceneActor) == 0x000008, "Wrong alignment on IGSCMovieSceneActor");
static_assert(sizeof(IGSCMovieSceneActor) == 0x000028, "Wrong size on IGSCMovieSceneActor");
