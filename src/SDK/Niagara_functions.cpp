...
class FString ANiagaraActor::GetAssetPathNameOrSetChangedHandler() const
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("NiagaraActor", "GetAssetPathNameOrSetChangedHandler");

	Params::NiagaraActor_GetAssetPathNameOrSetChangedHandler Parms{};
