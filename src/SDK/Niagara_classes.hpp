...
public:
	...
	class FString GetAssetPathNameOrSetChangedHandler() const;
...
public:
	...
	uint8                                         BitPad_658_2 : 6;                                  // 0x0658(0x0001)(Fixing Bit-Field Size For New Byte [ Dumper-7 ])
	uint8                                         Pad_659[0x37];                                     // 0x0659(0x0037)(Fixing Size After Last Property [ Dumper-7 ])
	...
	struct FNiagaraSystemTickLODArray             TickLODsInsideViewFrustum;                         // 0x0698(0x0010)(Edit, NativeAccessSpecifierPrivate)
	struct FNiagaraSystemTickLODArray             TickLODsOutsideViewFrustum;                        // 0x06A8(0x0010)(Edit, NativeAccessSpecifierPrivate)
	...
	TMulticastInlineDelegate<void(class UNiagaraComponent* PSystem)> OnSystemFinished;                                  // 0x06C8(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	...
	uint8                                         Pad_6EB[0x9];                                      // 0x06EB(0x0009)(Fixing Size After Last Property [ Dumper-7 ])
	uint8                                         BitPad_6F4_0 : 4;                                  // 0x06F4(0x0001)(Fixing Bit-Field Size Between Bits [ Dumper-7 ])
	uint8                                         bAllowScalability : 1;                             // 0x06F4(0x0001)(BitIndex: 0x04, PropSize: 0x0001 (Edit, BlueprintVisible, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate))
	uint8                                         Pad_6F5[0x12B];                                    // 0x06F5(0x012B)(Fixing Size After Last Property [ Dumper-7 ])
	class UNiagaraSimCache*                       SimCache;                                          // 0x0820(0x0008)(ZeroConstructor, Transient, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	class UNiagaraCullProxyComponent*             CullProxy;                                         // 0x0828(0x0008)(ExportObject, ZeroConstructor, Transient, InstancedReference, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
...
static_assert(sizeof(UNiagaraComponent) == 0x000830, "Wrong size on UNiagaraComponent");
...
static_assert(offsetof(UNiagaraComponent, TickLODsInsideViewFrustum) == 0x000698, "Member 'UNiagaraComponent::TickLODsInsideViewFrustum' has a wrong offset!");
static_assert(offsetof(UNiagaraComponent, TickLODsOutsideViewFrustum) == 0x0006A8, "Member 'UNiagaraComponent::TickLODsOutsideViewFrustum' has a wrong offset!");
...
static_assert(offsetof(UNiagaraComponent, AutoAttachLocationRule) == 0x0006E8, "Member 'UNiagaraComponent::AutoAttachLocationRule' has a wrong offset!");
static_assert(offsetof(UNiagaraComponent, AutoAttachRotationRule) == 0x0006E9, "Member 'UNiagaraComponent::AutoAttachRotationRule' has a wrong offset!");
static_assert(offsetof(UNiagaraComponent, AutoAttachScaleRule) == 0x0006EA, "Member 'UNiagaraComponent::AutoAttachScaleRule' has a wrong offset!");
static_assert(offsetof(UNiagaraComponent, SimCache) == 0x000820, "Member 'UNiagaraComponent::SimCache' has a wrong offset!");
static_assert(offsetof(UNiagaraComponent, CullProxy) == 0x000828, "Member 'UNiagaraComponent::CullProxy' has a wrong offset!");
...
{
public:
	TArray<struct FNiagaraCulledComponentInfo>    Instances;                                         // 0x0830(0x0010)(Edit, ZeroConstructor, NativeAccessSpecifierPublic)
...
static_assert(sizeof(UNiagaraCullProxyComponent) == 0x000840, "Wrong size on UNiagaraCullProxyComponent");
static_assert(offsetof(UNiagaraCullProxyComponent, Instances) == 0x000830, "Member 'UNiagaraCullProxyComponent::Instances' has a wrong offset!");
...
public:
	...
	struct FNiagaraSystemTickLODArray             TickLODsInsideViewFrustum;                         // 0x0090(0x0010)(Edit, NativeAccessSpecifierPrivate)
	struct FNiagaraSystemTickLODArray             TickLODsOutsideViewFrustum;                        // 0x00A0(0x0010)(Edit, NativeAccessSpecifierPrivate)
	struct FNiagaraPerfBaselineStats              PerfBaselineStats;                                 // 0x00B0(0x0010)(Config, NoDestructor, NativeAccessSpecifierPrivate)
	struct FGuid                                  PerfBaselineVersion;                               // 0x00C0(0x0010)(ZeroConstructor, Config, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
...
static_assert(sizeof(UNiagaraEffectType) == 0x0000D0, "Wrong size on UNiagaraEffectType");
...
static_assert(offsetof(UNiagaraEffectType, TickLODsInsideViewFrustum) == 0x000090, "Member 'UNiagaraEffectType::TickLODsInsideViewFrustum' has a wrong offset!");
static_assert(offsetof(UNiagaraEffectType, TickLODsOutsideViewFrustum) == 0x0000A0, "Member 'UNiagaraEffectType::TickLODsOutsideViewFrustum' has a wrong offset!");
static_assert(offsetof(UNiagaraEffectType, PerfBaselineStats) == 0x0000B0, "Member 'UNiagaraEffectType::PerfBaselineStats' has a wrong offset!");
static_assert(offsetof(UNiagaraEffectType, PerfBaselineVersion) == 0x0000C0, "Member 'UNiagaraEffectType::PerfBaselineVersion' has a wrong offset!");
...
public:
	...
	struct FNiagaraSystemTickLODArray             TickLODsInsideViewFrustum;                         // 0x0068(0x0010)(Edit, NativeAccessSpecifierPublic)
	struct FNiagaraSystemTickLODArray             TickLODsOutsideViewFrustum;                        // 0x0078(0x0010)(Edit, NativeAccessSpecifierPublic)
	...
	struct FBox                                   FixedBounds;                                       // 0x0400(0x0038)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, Protected, NativeAccessSpecifierProtected)
	bool                                          bAutoDeactivate;                                   // 0x0438(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	bool                                          bDeterminism;                                      // 0x0439(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	uint8                                         Pad_43A[0x2];                                      // 0x043A(0x0002)(Fixing Size After Last Property [ Dumper-7 ])
	int32                                         RandomSeed;                                        // 0x043C(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	float                                         WarmupTime;                                        // 0x0440(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	int32                                         WarmupTickCount;                                   // 0x0444(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	float                                         WarmupTickDelta;                                   // 0x0448(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	bool                                          bFixedTickDelta;                                   // 0x044C(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	uint8                                         Pad_44D[0x3];                                      // 0x044D(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	float                                         FixedTickDeltaTime;                                // 0x0450(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	bool                                          bHasSystemScriptDIsWithPerInstanceData;            // 0x0454(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	bool                                          bNeedsGPUContextInitForDataInterfaces;             // 0x0455(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	uint8                                         Pad_456[0x2];                                      // 0x0456(0x0002)(Fixing Size After Last Property [ Dumper-7 ])
	TArray<class FName>                           UserDINamesReadInSystemScripts;                    // 0x0458(0x0010)(ZeroConstructor, Protected, NativeAccessSpecifierProtected)
	uint8                                         Pad_468[0x140];                                    // 0x0468(0x0140)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(UNiagaraSystem) == 0x0005A8, "Wrong size on UNiagaraSystem");
...
static_assert(offsetof(UNiagaraSystem, TickLODsInsideViewFrustum) == 0x000068, "Member 'UNiagaraSystem::TickLODsInsideViewFrustum' has a wrong offset!");
static_assert(offsetof(UNiagaraSystem, TickLODsOutsideViewFrustum) == 0x000078, "Member 'UNiagaraSystem::TickLODsOutsideViewFrustum' has a wrong offset!");
...
static_assert(offsetof(UNiagaraSystem, bAutoDeactivate) == 0x000438, "Member 'UNiagaraSystem::bAutoDeactivate' has a wrong offset!");
static_assert(offsetof(UNiagaraSystem, bDeterminism) == 0x000439, "Member 'UNiagaraSystem::bDeterminism' has a wrong offset!");
static_assert(offsetof(UNiagaraSystem, RandomSeed) == 0x00043C, "Member 'UNiagaraSystem::RandomSeed' has a wrong offset!");
static_assert(offsetof(UNiagaraSystem, WarmupTime) == 0x000440, "Member 'UNiagaraSystem::WarmupTime' has a wrong offset!");
static_assert(offsetof(UNiagaraSystem, WarmupTickCount) == 0x000444, "Member 'UNiagaraSystem::WarmupTickCount' has a wrong offset!");
static_assert(offsetof(UNiagaraSystem, WarmupTickDelta) == 0x000448, "Member 'UNiagaraSystem::WarmupTickDelta' has a wrong offset!");
static_assert(offsetof(UNiagaraSystem, bFixedTickDelta) == 0x00044C, "Member 'UNiagaraSystem::bFixedTickDelta' has a wrong offset!");
static_assert(offsetof(UNiagaraSystem, FixedTickDeltaTime) == 0x000450, "Member 'UNiagaraSystem::FixedTickDeltaTime' has a wrong offset!");
static_assert(offsetof(UNiagaraSystem, bHasSystemScriptDIsWithPerInstanceData) == 0x000454, "Member 'UNiagaraSystem::bHasSystemScriptDIsWithPerInstanceData' has a wrong offset!");
static_assert(offsetof(UNiagaraSystem, bNeedsGPUContextInitForDataInterfaces) == 0x000455, "Member 'UNiagaraSystem::bNeedsGPUContextInitForDataInterfaces' has a wrong offset!");
static_assert(offsetof(UNiagaraSystem, UserDINamesReadInSystemScripts) == 0x000458, "Member 'UNiagaraSystem::UserDINamesReadInSystemScripts' has a wrong offset!");
