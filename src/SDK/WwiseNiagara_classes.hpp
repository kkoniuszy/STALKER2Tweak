...
public:
	...
	float                                         OcclusionRefreshInterval;                          // 0x005C(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, AdvancedDisplay, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(offsetof(UNiagaraDataInterfaceWwiseEvent, OcclusionRefreshInterval) == 0x00005C, "Member 'UNiagaraDataInterfaceWwiseEvent::OcclusionRefreshInterval' has a wrong offset!");
