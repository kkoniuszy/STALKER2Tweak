...
// Function EnhancedInput.InputMappingContext.SetIgnoreAlwaysForAction
// 0x0010 (0x0010 - 0x0000)
struct InputMappingContext_SetIgnoreAlwaysForAction final
{
public:
	const class UInputAction*                     Action;                                            // 0x0000(0x0008)(ConstParm, Parm, ZeroConstructor, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bIgnore;                                           // 0x0008(0x0001)(ConstParm, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_9[0x7];                                        // 0x0009(0x0007)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(InputMappingContext_SetIgnoreAlwaysForAction) == 0x000008, "Wrong alignment on InputMappingContext_SetIgnoreAlwaysForAction");
static_assert(sizeof(InputMappingContext_SetIgnoreAlwaysForAction) == 0x000010, "Wrong size on InputMappingContext_SetIgnoreAlwaysForAction");
static_assert(offsetof(InputMappingContext_SetIgnoreAlwaysForAction, Action) == 0x000000, "Member 'InputMappingContext_SetIgnoreAlwaysForAction::Action' has a wrong offset!");
static_assert(offsetof(InputMappingContext_SetIgnoreAlwaysForAction, bIgnore) == 0x000008, "Member 'InputMappingContext_SetIgnoreAlwaysForAction::bIgnore' has a wrong offset!");
