...
public:
	...
	FMulticastInlineDelegateProperty_             OnComponentFracture;                               // 0x08F0(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
