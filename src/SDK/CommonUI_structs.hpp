...
public:
	...
	struct FCommonInputTypeInfo                   KeyboardInputTypeInfo;                             // 0x0040(0x0110)(Edit, Protected, NativeAccessSpecifierProtected)
	struct FCommonInputTypeInfo                   DefaultGamepadInputTypeInfo;                       // 0x0150(0x0110)(Edit, Protected, NativeAccessSpecifierProtected)
	...
	struct FCommonInputTypeInfo                   TouchInputTypeInfo;                                // 0x02B0(0x0110)(Edit, Protected, NativeAccessSpecifierProtected)
};
static_assert(alignof(FCommonInputActionDataBase) == 0x000010, "Wrong alignment on FCommonInputActionDataBase");
static_assert(sizeof(FCommonInputActionDataBase) == 0x0003C0, "Wrong size on FCommonInputActionDataBase");
