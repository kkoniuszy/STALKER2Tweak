...
// Class MovieSceneTracks.GSCSkeletalAnimationSectionSelectable
// 0x0000 (0x0028 - 0x0028)
class IGSCSkeletalAnimationSectionSelectable final : public IInterface
{
public:
	static class UClass* StaticClass()
	{
		return StaticClassImpl<"GSCSkeletalAnimationSectionSelectable">();
	}
	static class IGSCSkeletalAnimationSectionSelectable* GetDefaultObj()
	{
		return GetDefaultObjImpl<IGSCSkeletalAnimationSectionSelectable>();
	}
};
static_assert(alignof(IGSCSkeletalAnimationSectionSelectable) == 0x000008, "Wrong alignment on IGSCSkeletalAnimationSectionSelectable");
static_assert(sizeof(IGSCSkeletalAnimationSectionSelectable) == 0x000028, "Wrong size on IGSCSkeletalAnimationSectionSelectable");

// Class MovieSceneTracks.MovieSceneSectionTemplateDecorator
// 0x0000 (0x0028 - 0x0028)
class IMovieSceneSectionTemplateDecorator final : public IInterface
{
public:
	static class UClass* StaticClass()
	{
		return StaticClassImpl<"MovieSceneSectionTemplateDecorator">();
	}
	static class IMovieSceneSectionTemplateDecorator* GetDefaultObj()
	{
		return GetDefaultObjImpl<IMovieSceneSectionTemplateDecorator>();
	}
};
static_assert(alignof(IMovieSceneSectionTemplateDecorator) == 0x000008, "Wrong alignment on IMovieSceneSectionTemplateDecorator");
static_assert(sizeof(IMovieSceneSectionTemplateDecorator) == 0x000028, "Wrong size on IMovieSceneSectionTemplateDecorator");
...
// 0x0550 (0x0640 - 0x00F0)
class UMovieSceneAudioSection final : public UMovieSceneSection
{
public:
	class FString                                 CharacterNameSID;                                  // 0x00F0(0x0010)(Edit, ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class FString                                 TextSID;                                           // 0x0100(0x0010)(Edit, ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class USoundBase*                             Sound;                                             // 0x0110(0x0008)(Edit, ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	struct FFrameNumber                           StartFrameOffset;                                  // 0x0118(0x0004)(Edit, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	...
	float                                         AudioStartTime;                                    // 0x0120(0x0004)(ZeroConstructor, Deprecated, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	float                                         AudioDilationFactor;                               // 0x0124(0x0004)(ZeroConstructor, Deprecated, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	float                                         AudioVolume;                                       // 0x0128(0x0004)(ZeroConstructor, Deprecated, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	uint8                                         Pad_12C[0x4];                                      // 0x012C(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	struct FMovieSceneFloatChannel                SoundVolume;                                       // 0x0130(0x0110)(NativeAccessSpecifierPrivate)
	struct FMovieSceneFloatChannel                PitchMultiplier;                                   // 0x0240(0x0110)(NativeAccessSpecifierPrivate)
	TMap<class FName, struct FMovieSceneFloatChannel> Inputs_Float;                                      // 0x0350(0x0050)(NativeAccessSpecifierPrivate)
	TMap<class FName, struct FMovieSceneStringChannel> Inputs_String;                                     // 0x03A0(0x0050)(NativeAccessSpecifierPrivate)
	TMap<class FName, struct FMovieSceneBoolChannel> Inputs_Bool;                                       // 0x03F0(0x0050)(NativeAccessSpecifierPrivate)
	TMap<class FName, struct FMovieSceneIntegerChannel> Inputs_Int;                                        // 0x0440(0x0050)(NativeAccessSpecifierPrivate)
	TMap<class FName, struct FMovieSceneAudioTriggerChannel> Inputs_Trigger;                                    // 0x0490(0x0050)(NativeAccessSpecifierPrivate)
	struct FMovieSceneActorReferenceData          AttachActorData;                                   // 0x04E0(0x0120)(NativeAccessSpecifierPrivate)
	...
	TDelegate<void(TArray<struct FSubtitleCue>& Subtitles, float CueDuration)> OnQueueSubtitles;                                  // 0x0610(0x0010)(ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
...
static_assert(offsetof(UMovieSceneAudioSection, CharacterNameSID) == 0x0000F0, "Member 'UMovieSceneAudioSection::CharacterNameSID' has a wrong offset!");
static_assert(offsetof(UMovieSceneAudioSection, TextSID) == 0x000100, "Member 'UMovieSceneAudioSection::TextSID' has a wrong offset!");
static_assert(offsetof(UMovieSceneAudioSection, Sound) == 0x000110, "Member 'UMovieSceneAudioSection::Sound' has a wrong offset!");
static_assert(offsetof(UMovieSceneAudioSection, StartFrameOffset) == 0x000118, "Member 'UMovieSceneAudioSection::StartFrameOffset' has a wrong offset!");
static_assert(offsetof(UMovieSceneAudioSection, StartOffset) == 0x00011C, "Member 'UMovieSceneAudioSection::StartOffset' has a wrong offset!");
static_assert(offsetof(UMovieSceneAudioSection, AudioStartTime) == 0x000120, "Member 'UMovieSceneAudioSection::AudioStartTime' has a wrong offset!");
static_assert(offsetof(UMovieSceneAudioSection, AudioDilationFactor) == 0x000124, "Member 'UMovieSceneAudioSection::AudioDilationFactor' has a wrong offset!");
static_assert(offsetof(UMovieSceneAudioSection, AudioVolume) == 0x000128, "Member 'UMovieSceneAudioSection::AudioVolume' has a wrong offset!");
static_assert(offsetof(UMovieSceneAudioSection, SoundVolume) == 0x000130, "Member 'UMovieSceneAudioSection::SoundVolume' has a wrong offset!");
static_assert(offsetof(UMovieSceneAudioSection, PitchMultiplier) == 0x000240, "Member 'UMovieSceneAudioSection::PitchMultiplier' has a wrong offset!");
static_assert(offsetof(UMovieSceneAudioSection, Inputs_Float) == 0x000350, "Member 'UMovieSceneAudioSection::Inputs_Float' has a wrong offset!");
static_assert(offsetof(UMovieSceneAudioSection, Inputs_String) == 0x0003A0, "Member 'UMovieSceneAudioSection::Inputs_String' has a wrong offset!");
static_assert(offsetof(UMovieSceneAudioSection, Inputs_Bool) == 0x0003F0, "Member 'UMovieSceneAudioSection::Inputs_Bool' has a wrong offset!");
static_assert(offsetof(UMovieSceneAudioSection, Inputs_Int) == 0x000440, "Member 'UMovieSceneAudioSection::Inputs_Int' has a wrong offset!");
static_assert(offsetof(UMovieSceneAudioSection, Inputs_Trigger) == 0x000490, "Member 'UMovieSceneAudioSection::Inputs_Trigger' has a wrong offset!");
static_assert(offsetof(UMovieSceneAudioSection, AttachActorData) == 0x0004E0, "Member 'UMovieSceneAudioSection::AttachActorData' has a wrong offset!");
...
public:
	...
	uint8                                         Pad_2DD[0x6B];                                     // 0x02DD(0x006B)(Fixing Size After Last Property [ Dumper-7 ])
	TSoftObjectPtr<class AActor>                  SyncActor;                                         // 0x0348(0x0030)(Edit, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FVector                                SyncLocation;                                      // 0x0378(0x0018)(Edit, ZeroConstructor, EditConst, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FRotator                               SyncRotation;                                      // 0x0390(0x0018)(Edit, ZeroConstructor, EditConst, IsPlainOldData, NoDestructor, NativeAccessSpecifierPublic)
	TSoftObjectPtr<class AActor>                  DynamicSyncActor;                                  // 0x03A8(0x0030)(Edit, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FGuid                                  DynamicSyncGuid;                                   // 0x03D8(0x0010)(Edit, ZeroConstructor, EditConst, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FRotator                               OverrideRotation;                                  // 0x03E8(0x0018)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, NativeAccessSpecifierPublic)
	int32                                         BlendFramesNum;                                    // 0x0400(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         BlendExpForEaseInOut;                              // 0x0404(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bUsedForPreblend;                                  // 0x0408(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(UMovieSceneSkeletalAnimationSection) == 0x000410, "Wrong size on UMovieSceneSkeletalAnimationSection");
...
static_assert(offsetof(UMovieSceneSkeletalAnimationSection, SyncActor) == 0x000348, "Member 'UMovieSceneSkeletalAnimationSection::SyncActor' has a wrong offset!");
static_assert(offsetof(UMovieSceneSkeletalAnimationSection, SyncLocation) == 0x000378, "Member 'UMovieSceneSkeletalAnimationSection::SyncLocation' has a wrong offset!");
static_assert(offsetof(UMovieSceneSkeletalAnimationSection, SyncRotation) == 0x000390, "Member 'UMovieSceneSkeletalAnimationSection::SyncRotation' has a wrong offset!");
static_assert(offsetof(UMovieSceneSkeletalAnimationSection, DynamicSyncActor) == 0x0003A8, "Member 'UMovieSceneSkeletalAnimationSection::DynamicSyncActor' has a wrong offset!");
static_assert(offsetof(UMovieSceneSkeletalAnimationSection, DynamicSyncGuid) == 0x0003D8, "Member 'UMovieSceneSkeletalAnimationSection::DynamicSyncGuid' has a wrong offset!");
static_assert(offsetof(UMovieSceneSkeletalAnimationSection, OverrideRotation) == 0x0003E8, "Member 'UMovieSceneSkeletalAnimationSection::OverrideRotation' has a wrong offset!");
static_assert(offsetof(UMovieSceneSkeletalAnimationSection, BlendFramesNum) == 0x000400, "Member 'UMovieSceneSkeletalAnimationSection::BlendFramesNum' has a wrong offset!");
static_assert(offsetof(UMovieSceneSkeletalAnimationSection, BlendExpForEaseInOut) == 0x000404, "Member 'UMovieSceneSkeletalAnimationSection::BlendExpForEaseInOut' has a wrong offset!");
static_assert(offsetof(UMovieSceneSkeletalAnimationSection, bUsedForPreblend) == 0x000408, "Member 'UMovieSceneSkeletalAnimationSection::bUsedForPreblend' has a wrong offset!");
...
public:
	...
	bool                                          bGSCIgnoreRootMotion;                              // 0x00E9(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(offsetof(UMovieSceneSkeletalAnimationTrack, bGSCIgnoreRootMotion) == 0x0000E9, "Member 'UMovieSceneSkeletalAnimationTrack::bGSCIgnoreRootMotion' has a wrong offset!");
