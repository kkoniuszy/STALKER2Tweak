...
struct alignas(0x04) FPaintedTriangleID final
{
public:
	uint8                                         Pad_0[0x4];                                        // 0x0000(0x0004)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(FPaintedTriangleID) == 0x000004, "Wrong alignment on FPaintedTriangleID");
static_assert(sizeof(FPaintedTriangleID) == 0x000004, "Wrong size on FPaintedTriangleID");
