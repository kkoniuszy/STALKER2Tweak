...
public:
	...
	struct FPhysicsControlTarget                  ControlTarget;                                     // 0x0040(0x0068)(ConstParm, Parm, NoDestructor, NativeAccessSpecifierPublic)
	struct FPhysicsControlSettings                ControlSettings;                                   // 0x00A8(0x0028)(ConstParm, Parm, NoDestructor, NativeAccessSpecifierPublic)
	class FName                                   Set;                                               // 0x00D0(0x0008)(Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bEnabled;                                          // 0x00D8(0x0001)(ConstParm, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_D9[0x3];                                       // 0x00D9(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	class FName                                   ReturnValue;                                       // 0x00DC(0x0008)(Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(PhysicsControlComponent_CreateControl) == 0x0000E8, "Wrong size on PhysicsControlComponent_CreateControl");
...
static_assert(offsetof(PhysicsControlComponent_CreateControl, ControlSettings) == 0x0000A8, "Member 'PhysicsControlComponent_CreateControl::ControlSettings' has a wrong offset!");
static_assert(offsetof(PhysicsControlComponent_CreateControl, Set) == 0x0000D0, "Member 'PhysicsControlComponent_CreateControl::Set' has a wrong offset!");
static_assert(offsetof(PhysicsControlComponent_CreateControl, bEnabled) == 0x0000D8, "Member 'PhysicsControlComponent_CreateControl::bEnabled' has a wrong offset!");
static_assert(offsetof(PhysicsControlComponent_CreateControl, ReturnValue) == 0x0000DC, "Member 'PhysicsControlComponent_CreateControl::ReturnValue' has a wrong offset!");
...
public:
	...
	bool                                          bEnabled;                                          // 0x0070(0x0001)(ConstParm, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(offsetof(PhysicsControlComponent_CreateControlsFromSkeletalMesh, bEnabled) == 0x000070, "Member 'PhysicsControlComponent_CreateControlsFromSkeletalMesh::bEnabled' has a wrong offset!");
...
public:
	...
	class FName                                   Set;                                               // 0x0060(0x0008)(ConstParm, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bEnabled;                                          // 0x0068(0x0001)(ConstParm, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_69[0x7];                                       // 0x0069(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
...
static_assert(offsetof(PhysicsControlComponent_CreateControlsFromSkeletalMeshBelow, bEnabled) == 0x000068, "Member 'PhysicsControlComponent_CreateControlsFromSkeletalMeshBelow::bEnabled' has a wrong offset!");
...
public:
	...
	class FName                                   Set;                                               // 0x00D8(0x0008)(ConstParm, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bEnabled;                                          // 0x00E0(0x0001)(ConstParm, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(offsetof(PhysicsControlComponent_CreateNamedControl, ControlSettings) == 0x0000B0, "Member 'PhysicsControlComponent_CreateNamedControl::ControlSettings' has a wrong offset!");
static_assert(offsetof(PhysicsControlComponent_CreateNamedControl, Set) == 0x0000D8, "Member 'PhysicsControlComponent_CreateNamedControl::Set' has a wrong offset!");
static_assert(offsetof(PhysicsControlComponent_CreateNamedControl, bEnabled) == 0x0000E0, "Member 'PhysicsControlComponent_CreateNamedControl::bEnabled' has a wrong offset!");
static_assert(offsetof(PhysicsControlComponent_CreateNamedControl, ReturnValue) == 0x0000E1, "Member 'PhysicsControlComponent_CreateNamedControl::ReturnValue' has a wrong offset!");
