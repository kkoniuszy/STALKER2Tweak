...
static_assert(sizeof(FPhysicsControl) == 0x000140, "Wrong size on FPhysicsControl");
...
static_assert(offsetof(FPhysicsControl, ControlTarget) == 0x0000B0, "Member 'FPhysicsControl::ControlTarget' has a wrong offset!");
static_assert(offsetof(FPhysicsControl, ControlSettings) == 0x000118, "Member 'FPhysicsControl::ControlSettings' has a wrong offset!");
...
static_assert(sizeof(FInitialCharacterControls) == 0x0000C0, "Wrong size on FInitialCharacterControls");
...
static_assert(offsetof(FInitialCharacterControls, bEnableWorldSpaceControls) == 0x000068, "Member 'FInitialCharacterControls::bEnableWorldSpaceControls' has a wrong offset!");
static_assert(offsetof(FInitialCharacterControls, ParentSpaceControlData) == 0x00006C, "Member 'FInitialCharacterControls::ParentSpaceControlData' has a wrong offset!");
static_assert(offsetof(FInitialCharacterControls, ParentSpaceControlSettings) == 0x000090, "Member 'FInitialCharacterControls::ParentSpaceControlSettings' has a wrong offset!");
static_assert(offsetof(FInitialCharacterControls, bEnableParentSpaceControls) == 0x0000B8, "Member 'FInitialCharacterControls::bEnableParentSpaceControls' has a wrong offset!");
static_assert(offsetof(FInitialCharacterControls, PhysicsMovementType) == 0x0000B9, "Member 'FInitialCharacterControls::PhysicsMovementType' has a wrong offset!");
