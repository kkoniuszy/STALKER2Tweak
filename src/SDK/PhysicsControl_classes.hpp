...
static_assert(sizeof(UPhysicsControlComponent) == 0x0002F0, "Wrong size on UPhysicsControlComponent");
static_assert(offsetof(UPhysicsControlComponent, TeleportDistanceThreshold) == 0x0002A0, "Member 'UPhysicsControlComponent::TeleportDistanceThreshold' has a wrong offset!");
static_assert(offsetof(UPhysicsControlComponent, TeleportRotationThreshold) == 0x0002A4, "Member 'UPhysicsControlComponent::TeleportRotationThreshold' has a wrong offset!");
static_assert(offsetof(UPhysicsControlComponent, bShowDebugVisualization) == 0x0002A8, "Member 'UPhysicsControlComponent::bShowDebugVisualization' has a wrong offset!");
static_assert(offsetof(UPhysicsControlComponent, VisualizationSizeScale) == 0x0002AC, "Member 'UPhysicsControlComponent::VisualizationSizeScale' has a wrong offset!");
static_assert(offsetof(UPhysicsControlComponent, bShowDebugControlList) == 0x0002B0, "Member 'UPhysicsControlComponent::bShowDebugControlList' has a wrong offset!");
static_assert(offsetof(UPhysicsControlComponent, DebugControlDetailFilter) == 0x0002B8, "Member 'UPhysicsControlComponent::DebugControlDetailFilter' has a wrong offset!");
static_assert(offsetof(UPhysicsControlComponent, bShowDebugBodyModifierList) == 0x0002C8, "Member 'UPhysicsControlComponent::bShowDebugBodyModifierList' has a wrong offset!");
static_assert(offsetof(UPhysicsControlComponent, DebugBodyModifierDetailFilter) == 0x0002D0, "Member 'UPhysicsControlComponent::DebugBodyModifierDetailFilter' has a wrong offset!");
static_assert(offsetof(UPhysicsControlComponent, VelocityPredictionTime) == 0x0002E0, "Member 'UPhysicsControlComponent::VelocityPredictionTime' has a wrong offset!");
static_assert(offsetof(UPhysicsControlComponent, MaxNumControlsOrModifiersPerName) == 0x0002E4, "Member 'UPhysicsControlComponent::MaxNumControlsOrModifiersPerName' has a wrong offset!");
...
public:
	...
	float                                         TestValue;                                         // 0x0060(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(UPhysicsControlProfileAsset) == 0x000068, "Wrong size on UPhysicsControlProfileAsset");
...
static_assert(offsetof(UPhysicsControlProfileAsset, TestValue) == 0x000060, "Member 'UPhysicsControlProfileAsset::TestValue' has a wrong offset!");
...
static_assert(sizeof(UPhysicsControlInitializerComponent) == 0x000410, "Wrong size on UPhysicsControlInitializerComponent");
static_assert(offsetof(UPhysicsControlInitializerComponent, InitialCharacterControls) == 0x0002A0, "Member 'UPhysicsControlInitializerComponent::InitialCharacterControls' has a wrong offset!");
static_assert(offsetof(UPhysicsControlInitializerComponent, InitialControls) == 0x000360, "Member 'UPhysicsControlInitializerComponent::InitialControls' has a wrong offset!");
static_assert(offsetof(UPhysicsControlInitializerComponent, InitialBodyModifiers) == 0x0003B0, "Member 'UPhysicsControlInitializerComponent::InitialBodyModifiers' has a wrong offset!");
static_assert(offsetof(UPhysicsControlInitializerComponent, bCreateControlsAtBeginPlay) == 0x000400, "Member 'UPhysicsControlInitializerComponent::bCreateControlsAtBeginPlay' has a wrong offset!");
...
{
public:
	class UPhysicsControlComponent*               ControlComponent;                                  // 0x0298(0x0008)(Edit, BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, EditConst, InstancedReference, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	class UPhysicsControlInitializerComponent*    ControlInitializerComponent;                       // 0x02A0(0x0008)(Edit, BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, EditConst, InstancedReference, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
...
static_assert(sizeof(APhysicsControlActor) == 0x0002A8, "Wrong size on APhysicsControlActor");
static_assert(offsetof(APhysicsControlActor, ControlComponent) == 0x000298, "Member 'APhysicsControlActor::ControlComponent' has a wrong offset!");
static_assert(offsetof(APhysicsControlActor, ControlInitializerComponent) == 0x0002A0, "Member 'APhysicsControlActor::ControlInitializerComponent' has a wrong offset!");
