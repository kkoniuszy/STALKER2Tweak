...
// Enum Niagara.EFTickBehaviour
// NumValues: 0x0004
enum class EFTickBehaviour : uint32
{
...
public:
	...
	uint8                                         bScaleSpawnCountByDistanceCurve : 1;               // 0x0038(0x0001)(BitIndex: 0x00, PropSize: 0x0001 (Edit, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         Pad_39[0x3];                                       // 0x0039(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	struct FNiagaraLinearRamp                     SpawnCountScaleCurve;                              // 0x003C(0x0010)(Edit, NoDestructor, NativeAccessSpecifierPublic)
	uint8                                         Pad_4C[0x4];                                       // 0x004C(0x0004)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(FNiagaraEmitterScalabilitySettings) == 0x000008, "Wrong alignment on FNiagaraEmitterScalabilitySettings");
static_assert(sizeof(FNiagaraEmitterScalabilitySettings) == 0x000050, "Wrong size on FNiagaraEmitterScalabilitySettings");
...
static_assert(offsetof(FNiagaraEmitterScalabilitySettings, SpawnCountScaleCurve) == 0x00003C, "Member 'FNiagaraEmitterScalabilitySettings::SpawnCountScaleCurve' has a wrong offset!");
...
{
public:
	uint8                                         bOverrideSpawnCountScale : 1;                      // 0x0050(0x0001)(BitIndex: 0x00, PropSize: 0x0001 (Edit, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
...
static_assert(sizeof(FNiagaraEmitterScalabilityOverride) == 0x000058, "Wrong size on FNiagaraEmitterScalabilityOverride");
...
// ScriptStruct Niagara.NiagaraSystemTickLOD
// 0x0014 (0x0014 - 0x0000)
struct FNiagaraSystemTickLOD final
{
public:
	EFTickBehaviour                               TickBehaviour;                                     // 0x0000(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         ScreenSize;                                        // 0x0004(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	int32                                         TicksCountToSkip;                                  // 0x0008(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         TickDeltaScale;                                    // 0x000C(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bUseMotionVectors;                                 // 0x0010(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_11[0x3];                                       // 0x0011(0x0003)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(FNiagaraSystemTickLOD) == 0x000004, "Wrong alignment on FNiagaraSystemTickLOD");
static_assert(sizeof(FNiagaraSystemTickLOD) == 0x000014, "Wrong size on FNiagaraSystemTickLOD");
static_assert(offsetof(FNiagaraSystemTickLOD, TickBehaviour) == 0x000000, "Member 'FNiagaraSystemTickLOD::TickBehaviour' has a wrong offset!");
static_assert(offsetof(FNiagaraSystemTickLOD, ScreenSize) == 0x000004, "Member 'FNiagaraSystemTickLOD::ScreenSize' has a wrong offset!");
static_assert(offsetof(FNiagaraSystemTickLOD, TicksCountToSkip) == 0x000008, "Member 'FNiagaraSystemTickLOD::TicksCountToSkip' has a wrong offset!");
static_assert(offsetof(FNiagaraSystemTickLOD, TickDeltaScale) == 0x00000C, "Member 'FNiagaraSystemTickLOD::TickDeltaScale' has a wrong offset!");
static_assert(offsetof(FNiagaraSystemTickLOD, bUseMotionVectors) == 0x000010, "Member 'FNiagaraSystemTickLOD::bUseMotionVectors' has a wrong offset!");

// ScriptStruct Niagara.NiagaraSystemTickLODArray
// 0x0010 (0x0010 - 0x0000)
struct FNiagaraSystemTickLODArray final
{
public:
	TArray<struct FNiagaraSystemTickLOD>          LODs;                                              // 0x0000(0x0010)(Edit, ZeroConstructor, NativeAccessSpecifierPublic)
};
static_assert(alignof(FNiagaraSystemTickLODArray) == 0x000008, "Wrong alignment on FNiagaraSystemTickLODArray");
static_assert(sizeof(FNiagaraSystemTickLODArray) == 0x000010, "Wrong size on FNiagaraSystemTickLODArray");
static_assert(offsetof(FNiagaraSystemTickLODArray, LODs) == 0x000000, "Member 'FNiagaraSystemTickLODArray::LODs' has a wrong offset!");
...
public:
	...
	struct FNiagaraEmitterScalabilitySettings     CurrentScalabilitySettings;                        // 0x0248(0x0050)(Transient, NativeAccessSpecifierPrivate)
